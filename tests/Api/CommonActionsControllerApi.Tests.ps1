...
Describe -tag 'maislurp-client-powershell' -name 'CommonActionsControllerApi' {
    ...
    Context 'New-RandomInbox' {
        It 'Test New-RandomInbox' {
            #$TestResult = New-RandomInbox -AllowTeamAccess "TEST_VALUE" -UseDomainPool "TEST_VALUE" -ExpiresAt "TEST_VALUE" -ExpiresIn "TEST_VALUE" -EmailAddress "TEST_VALUE" -InboxType "TEST_VALUE" -Description "TEST_VALUE" -Name "TEST_VALUE" -Tags "TEST_VALUE" -Favourite "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
