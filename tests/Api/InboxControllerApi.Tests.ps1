...
Describe -tag 'maislurp-client-powershell' -name 'InboxControllerApi' {
    Context 'New-Inbox' {
        It 'Test New-Inbox' {
            #$TestResult = New-Inbox -AllowTeamAccess "TEST_VALUE" -Description "TEST_VALUE" -EmailAddress "TEST_VALUE" -ExpiresAt "TEST_VALUE" -ExpiresIn "TEST_VALUE" -Favourite "TEST_VALUE" -Name "TEST_VALUE" -Tags "TEST_VALUE" -UseDomainPool "TEST_VALUE"
    ...
    Context 'Get-InboxSentEmails' {
        It 'Test Get-InboxSentEmails' {
            #$TestResult = Get-InboxSentEmails -InboxId "TEST_VALUE" -Page "TEST_VALUE" -Size "TEST_VALUE" -Sort "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
    ...
    Context 'Get-OrganizationInboxes' {
        It 'Test Get-OrganizationInboxes' {
            #$TestResult = Get-OrganizationInboxes -Page "TEST_VALUE" -Size "TEST_VALUE" -Sort "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
