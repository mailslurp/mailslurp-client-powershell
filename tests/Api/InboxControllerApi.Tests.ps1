...
Describe -tag 'maislurp-client-powershell' -name 'InboxControllerApi' {
    ...
    Context 'Get-Inboxes' {
        It 'Test Get-Inboxes' {
            #$TestResult = Get-Inboxes -Size "TEST_VALUE" -Sort "TEST_VALUE" -Since "TEST_VALUE" -ExcludeCatchAllInboxes "TEST_VALUE" -Before "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
