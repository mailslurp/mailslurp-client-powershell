...
Describe -tag 'maislurp-client-powershell' -name 'InboxControllerApi' {
    ...
    Context 'New-Inbox' {
        It 'Test New-Inbox' {
            #$TestResult = New-Inbox -EmailAddress "TEST_VALUE" -Tags "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -UseDomainPool "TEST_VALUE" -Favourite "TEST_VALUE" -ExpiresAt "TEST_VALUE" -ExpiresIn "TEST_VALUE" -AllowTeamAccess "TEST_VALUE" -InboxType "TEST_VALUE" -VirtualInbox "TEST_VALUE" -UseShortAddress "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
    ...
    Context 'Get-AllInboxes' {
        It 'Test Get-AllInboxes' {
            #$TestResult = Get-AllInboxes -Page "TEST_VALUE" -Size "TEST_VALUE" -Sort "TEST_VALUE" -Favourite "TEST_VALUE" -Search "TEST_VALUE" -Tag "TEST_VALUE" -TeamAccess "TEST_VALUE" -Since "TEST_VALUE" -Before "TEST_VALUE" -InboxType "TEST_VALUE" -DomainId "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
    ...
    Context 'Get-AllScheduledJobs' {
        It 'Test Get-AllScheduledJobs' {
            #$TestResult = Get-AllScheduledJobs -Page "TEST_VALUE" -Size "TEST_VALUE" -Sort "TEST_VALUE" -Since "TEST_VALUE" -Before "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
