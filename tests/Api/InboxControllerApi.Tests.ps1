...
Describe -tag 'maislurp-client-powershell' -name 'InboxControllerApi' {
    ...
    Context 'New-InboxRuleset' {
        It 'Test New-InboxRuleset' {
            #$TestResult = New-InboxRuleset -InboxId "TEST_VALUE" -CreateRulesetOptions "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
    ...
    Context 'Invoke-DoesInboxExist' {
        It 'Test Invoke-DoesInboxExist' {
            #$TestResult = Invoke-DoesInboxExist -EmailAddress "TEST_VALUE" -AllowCatchAll "TEST_VALUE" -IpAddress "TEST_VALUE" -Sender "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
    ...
    Context 'Get-OrCreateInboxPlusAddress' {
        It 'Test Get-OrCreateInboxPlusAddress' {
            #$TestResult = Get-OrCreateInboxPlusAddress -InboxId "TEST_VALUE" -FullAddress "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Get-OrCreatePlusAddressByFullAddress' {
        It 'Test Get-OrCreatePlusAddressByFullAddress' {
            #$TestResult = Get-OrCreatePlusAddressByFullAddress -FullAddress "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
    ...
    Context 'Import-EmailIntoInbox' {
        It 'Test Import-EmailIntoInbox' {
            #$TestResult = Import-EmailIntoInbox -InboxId "TEST_VALUE" -ImportEmailOptions "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Import-EmailIntoInboxBytes' {
        It 'Test Import-EmailIntoInboxBytes' {
            #$TestResult = Import-EmailIntoInboxBytes -InboxId "TEST_VALUE" -Body "TEST_VALUE" -ExternalId "TEST_VALUE" -RunPipeline "TEST_VALUE" -OverrideMessageId "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Import-EmailIntoInboxMultipart' {
        It 'Test Import-EmailIntoInboxMultipart' {
            #$TestResult = Import-EmailIntoInboxMultipart -InboxId "TEST_VALUE" -File "TEST_VALUE" -ExternalId "TEST_VALUE" -RunPipeline "TEST_VALUE" -OverrideMessageId "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
