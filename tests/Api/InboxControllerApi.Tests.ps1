...
Describe -tag 'maislurp-client-powershell' -name 'InboxControllerApi' {
    ...
    Context 'Get-AllInboxes' {
        It 'Test Get-AllInboxes' {
            #$TestResult = Get-AllInboxes -Before "TEST_VALUE" -Favourite "TEST_VALUE" -Page "TEST_VALUE" -Search "TEST_VALUE" -Since "TEST_VALUE" -Size "TEST_VALUE" -Sort "TEST_VALUE" -Tag "TEST_VALUE" -TeamAccess "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
    ...
    Context 'Get-Emails' {
        It 'Test Get-Emails' {
            #$TestResult = Get-Emails -InboxId "TEST_VALUE" -Before "TEST_VALUE" -DelayTimeout "TEST_VALUE" -Limit "TEST_VALUE" -MinCount "TEST_VALUE" -RetryTimeout "TEST_VALUE" -Since "TEST_VALUE" -Size "TEST_VALUE" -Sort "TEST_VALUE" -UnreadOnly "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
    ...
    Context 'Get-InboxEmailsPaginated' {
        It 'Test Get-InboxEmailsPaginated' {
            #$TestResult = Get-InboxEmailsPaginated -InboxId "TEST_VALUE" -Before "TEST_VALUE" -Page "TEST_VALUE" -Since "TEST_VALUE" -Size "TEST_VALUE" -Sort "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
    ...
    Context 'Get-InboxSentEmails' {
        It 'Test Get-InboxSentEmails' {
            #$TestResult = Get-InboxSentEmails -InboxId "TEST_VALUE" -Before "TEST_VALUE" -Page "TEST_VALUE" -SearchFilter "TEST_VALUE" -Since "TEST_VALUE" -Size "TEST_VALUE" -Sort "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
    ...
    Context 'Get-Inboxes' {
        It 'Test Get-Inboxes' {
            #$TestResult = Get-Inboxes -Before "TEST_VALUE" -Since "TEST_VALUE" -Size "TEST_VALUE" -Sort "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
    ...
    Context 'Get-OrganizationInboxes' {
        It 'Test Get-OrganizationInboxes' {
            #$TestResult = Get-OrganizationInboxes -Before "TEST_VALUE" -Page "TEST_VALUE" -SearchFilter "TEST_VALUE" -Since "TEST_VALUE" -Size "TEST_VALUE" -Sort "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
    ...
    Context 'Invoke-ListInboxRulesets' {
        It 'Test Invoke-ListInboxRulesets' {
            #$TestResult = Invoke-ListInboxRulesets -InboxId "TEST_VALUE" -Before "TEST_VALUE" -Page "TEST_VALUE" -SearchFilter "TEST_VALUE" -Since "TEST_VALUE" -Size "TEST_VALUE" -Sort "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
    ...
    Context 'Invoke-ListInboxTrackingPixels' {
        It 'Test Invoke-ListInboxTrackingPixels' {
            #$TestResult = Invoke-ListInboxTrackingPixels -InboxId "TEST_VALUE" -Before "TEST_VALUE" -Page "TEST_VALUE" -SearchFilter "TEST_VALUE" -Since "TEST_VALUE" -Size "TEST_VALUE" -Sort "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
