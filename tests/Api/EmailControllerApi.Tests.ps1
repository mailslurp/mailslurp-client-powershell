...
Describe -tag 'maislurp-client-powershell' -name 'EmailControllerApi' {
    ...
    Context 'Get-EmailHTMLJson' {
        It 'Test Get-EmailHTMLJson' {
            #$TestResult = Get-EmailHTMLJson -EmailId "TEST_VALUE" -Decode "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
    ...
    Context 'Send-EmailSourceOptional' {
        It 'Test Send-EmailSourceOptional' {
            #$TestResult = Send-EmailSourceOptional -InboxId "TEST_VALUE" -SendEmailOptions "TEST_VALUE" -UseDomainPool "TEST_VALUE" -VirtualSend "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
