...
Describe -tag 'maislurp-client-powershell' -name 'EmailControllerApi' {
    ...
    Context 'Invoke-DownloadAttachment' {
        It 'Test Invoke-DownloadAttachment' {
            #$TestResult = Invoke-DownloadAttachment -AttachmentId "TEST_VALUE" -EmailId "TEST_VALUE" -ApiKey "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
    ...
    Context 'Invoke-DownloadAttachmentBase64' {
        It 'Test Invoke-DownloadAttachmentBase64' {
            #$TestResult = Invoke-DownloadAttachmentBase64 -AttachmentId "TEST_VALUE" -EmailId "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
    ...
    Context 'Get-AttachmentMetaData' {
        It 'Test Get-AttachmentMetaData' {
            #$TestResult = Get-AttachmentMetaData -AttachmentId "TEST_VALUE" -EmailId "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
    ...
    Context 'Get-Attachments1' {
        It 'Test Get-Attachments1' {
            #$TestResult = Get-Attachments1 -EmailId "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
    ...
    Context 'Get-EmailsPaginated' {
        It 'Test Get-EmailsPaginated' {
            #$TestResult = Get-EmailsPaginated -Before "TEST_VALUE" -InboxId "TEST_VALUE" -Page "TEST_VALUE" -SearchFilter "TEST_VALUE" -Since "TEST_VALUE" -Size "TEST_VALUE" -Sort "TEST_VALUE" -UnreadOnly "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
    ...
    Context 'Get-OrganizationEmailsPaginated' {
        It 'Test Get-OrganizationEmailsPaginated' {
            #$TestResult = Get-OrganizationEmailsPaginated -Before "TEST_VALUE" -InboxId "TEST_VALUE" -Page "TEST_VALUE" -SearchFilter "TEST_VALUE" -Since "TEST_VALUE" -Size "TEST_VALUE" -Sort "TEST_VALUE" -UnreadOnly "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
    ...
    Context 'Send-EmailSourceOptional' {
        It 'Test Send-EmailSourceOptional' {
            #$TestResult = Send-EmailSourceOptional -InboxId "TEST_VALUE" -UseDomainPool "TEST_VALUE" -SendEmailOptions "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
