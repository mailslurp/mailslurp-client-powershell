...
Describe -tag 'maislurp-client-powershell' -name 'EmailControllerApi' {
    ...
    Context 'Invoke-CheckEmailAudit1' {
        It 'Test Invoke-CheckEmailAudit1' {
            #$TestResult = Invoke-CheckEmailAudit1 -EmailId "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
    ...
    Context 'New-EmailAuditForEmail' {
        It 'Test New-EmailAuditForEmail' {
            #$TestResult = New-EmailAuditForEmail -EmailId "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
    ...
    Context 'Get-EmailCodes' {
        It 'Test Get-EmailCodes' {
            #$TestResult = Get-EmailCodes -EmailId "TEST_VALUE" -ExtractCodesOptions "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
    ...
    Context 'Get-EmailSignature' {
        It 'Test Get-EmailSignature' {
            #$TestResult = Get-EmailSignature -EmailId "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
