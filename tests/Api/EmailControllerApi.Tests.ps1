...
Describe -tag 'maislurp-client-powershell' -name 'EmailControllerApi' {
    ...
    Context 'Get-EmailsPaginated' {
        It 'Test Get-EmailsPaginated' {
            #$TestResult = Get-EmailsPaginated -InboxId "TEST_VALUE" -Page "TEST_VALUE" -SearchFilter "TEST_VALUE" -Size "TEST_VALUE" -Sort "TEST_VALUE" -UnreadOnly "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
    ...
    Context 'Get-OrganizationEmailsPaginated' {
        It 'Test Get-OrganizationEmailsPaginated' {
            #$TestResult = Get-OrganizationEmailsPaginated -InboxId "TEST_VALUE" -Page "TEST_VALUE" -SearchFilter "TEST_VALUE" -Size "TEST_VALUE" -Sort "TEST_VALUE" -UnreadOnly "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
