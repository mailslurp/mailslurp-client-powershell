...
Describe -tag 'maislurp-client-powershell' -name 'UserControllerApi' {
    Context 'New-OrUpdateInboxRetentionPolicyForAccount' {
        It 'Test New-OrUpdateInboxRetentionPolicyForAccount' {
            #$TestResult = New-OrUpdateInboxRetentionPolicyForAccount -CreateInboxRetentionPolicyForAccountOptions "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Invoke-DeleteInboxRetentionPolicyForAccount' {
        It 'Test Invoke-DeleteInboxRetentionPolicyForAccount' {
            #$TestResult = Invoke-DeleteInboxRetentionPolicyForAccount
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
    ...
    Context 'Get-InboxRetentionPolicyForAccount' {
        It 'Test Get-InboxRetentionPolicyForAccount' {
            #$TestResult = Get-InboxRetentionPolicyForAccount
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
