...
[**Get-Attachments**](EmailControllerApi#Get-Attachments) | **GET** /emails/{emailId}/attachments | Get all email attachment metadata. Metadata includes name and attachment size.
