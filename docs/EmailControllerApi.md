...
$EmailId = "EmailId_example" # String | ID of email
$ForwardEmailOptions = (Initialize-ForwardEmailOptions -Bcc @("Bcc_example") -Cc @("Cc_example") -VarFrom "VarFrom_example" -Subject "Subject_example" -To @("To_example")) # ForwardEmailOptions | forwardEmailOptions
