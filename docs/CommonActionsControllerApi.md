...
$InboxId = "InboxId_example" # String | ID of inbox to delete
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **InboxId** | [**String**](String)| ID of inbox to delete | 
...
$InboxId = "InboxId_example" # String | ID of inbox to empty
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **InboxId** | [**String**](String)| ID of inbox to empty | 
