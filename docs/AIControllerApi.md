...
------------- | ------------- | -------------
[**New-Transformer**](AIControllerApi#New-Transformer) | **GET** /ai/transformer | List transformers
[**New-Transformer1**](AIControllerApi#New-Transformer1) | **POST** /ai/transformer | Create a transformer for reuse in automations
...
# **New-Transformer**
> PageAITransformProjection New-Transformer<br>
...
# List transformers
try {
     $Result = New-Transformer -Options $Options -Page $Page -Size $Size -Sort $Sort
} catch {
...
------------- | ------------- | ------------- | -------------
 **Options** | [**AITranformCreateOptions**](AITranformCreateOptions)|  | 
...
<a name="New-Transformer1"></a>
# **New-Transformer1**
> AITransformDto New-Transformer1<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-AITranformCreateOptions] <PSCustomObject><br>
...
$AITranformCreateOptions = (Initialize-AITranformCreateOptions -Name "Name_example" -Conditions @("Conditions_example") -Instructions @("Instructions_example") -OutputSchema ) # AITranformCreateOptions | 

# Create a transformer for reuse in automations
try {
     $Result = New-Transformer1 -AITranformCreateOptions $AITranformCreateOptions
} catch {
    Write-Host ("Exception occured when calling New-Transformer1: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
