...
[**Get-EmailIntelligence**](EmailVerificationControllerApi#Get-EmailIntelligence) | **POST** /email-verification/intelligence | Get intelligence score and breakdown for email/domain targets. Per unit billing for non-cached evaluations.
...
<a name="Get-EmailIntelligence"></a>
# **Get-EmailIntelligence**
> EmailIntelligenceListResult Get-EmailIntelligence<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EmailIntelligenceOptions] <PSCustomObject><br>
...
$EmailIntelligenceOptions = (Initialize-EmailIntelligenceOptions -Targets @("Targets_example") -Page 123 -Size 123 -IgnoreCache $false -IncludeEmailValidation $false -Tests (Initialize-EmailIntelligenceTestsOptions -CheckRandomLocalPart $false -CheckFreeProvider $false -CheckHttpsWebsite $false -CheckDns $false -CheckDomainAgeHint $false)) # EmailIntelligenceOptions | 

# Get intelligence score and breakdown for email/domain targets. Per unit billing for non-cached evaluations.
try {
     $Result = Get-EmailIntelligence -EmailIntelligenceOptions $EmailIntelligenceOptions
} catch {
    Write-Host ("Exception occured when calling Get-EmailIntelligence: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
[**EmailIntelligenceListResult**](EmailIntelligenceListResult) (PSCustomObject)
