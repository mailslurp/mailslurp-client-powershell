...
# **Get-InboxRulesets**
> PageInboxRulesetProjection Get-InboxRulesets<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-InboxId] <PSCustomObject><br>
...
# List inbox rulesets
try {
     $Result = Get-InboxRulesets -InboxId $InboxId -Page $Page -Size $Size -Sort $Sort
} catch {
...
[**PageInboxRulesetProjection**](PageInboxRulesetProjection) (PSCustomObject)
