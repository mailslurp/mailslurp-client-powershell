...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IDOfTheExpiredInboxRecordYouWantToRetrieveThisIsDifferentFromTheIDOfTheInboxYouAreInterestedInSeeOtherMethodsForGettingExpiredInboxRecordForAnInboxInboxId] <PSCustomObject><br>
...
# Get an expired inbox record
try {
     $Result = Get-ExpiredInboxRecord -IDOfTheExpiredInboxRecordYouWantToRetrieveThisIsDifferentFromTheIDOfTheInboxYouAreInterestedInSeeOtherMethodsForGettingExpiredInboxRecordForAnInboxInboxId $IDOfTheExpiredInboxRecordYouWantToRetrieveThisIsDifferentFromTheIDOfTheInboxYouAreInterestedInSeeOtherMethodsForGettingExpiredInboxRecordForAnInboxInboxId
} catch {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **IDOfTheExpiredInboxRecordYouWantToRetrieveThisIsDifferentFromTheIDOfTheInboxYouAreInterestedInSeeOtherMethodsForGettingExpiredInboxRecordForAnInboxInboxId** | [**String**](String)|  | 
...
# List records of expired inboxes
try {
     $Result = Get-ExpiredInboxes -Page $Page -Size $Size -Sort $Sort -Since $Since -Before $Before
} catch {
