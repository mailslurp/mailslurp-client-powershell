...
[**Invoke-DoesInboxHaveAutomations**](InboxControllerApi#Invoke-DoesInboxHaveAutomations) | **GET** /inboxes/automations | Does inbox have automations
...
[**Get-OrCreateInboxPlusAddress**](InboxControllerApi#Get-OrCreateInboxPlusAddress) | **POST** /inboxes/{inboxId}/plus-addresses/get-or-create | Get or create a plus address by full address
[**Get-OrCreatePlusAddressByFullAddress**](InboxControllerApi#Get-OrCreatePlusAddressByFullAddress) | **POST** /inboxes/get-or-create-plus-address | Get or create a plus address by full address without inbox ID
...
[**Import-EmailIntoInbox**](InboxControllerApi#Import-EmailIntoInbox) | **POST** /inboxes/{inboxId}/emails/import | Import email into inbox from base64 MIME
[**Import-EmailIntoInboxBytes**](InboxControllerApi#Import-EmailIntoInboxBytes) | **POST** /inboxes/{inboxId}/emails/import/raw | Import email into inbox from raw MIME bytes
[**Import-EmailIntoInboxMultipart**](InboxControllerApi#Import-EmailIntoInboxMultipart) | **POST** /inboxes/{inboxId}/emails/import/multipart | Import email into inbox from multipart EML upload
...
# **New-InboxRuleset**
> RulesetDto New-InboxRuleset<br>
...
# Create an inbox ruleset
try {
     $Result = New-InboxRuleset -InboxId $InboxId -CreateRulesetOptions $CreateRulesetOptions
} catch {
...
$AllowCatchAll = true # Boolean | Allow catch all (optional)
$IpAddress = "IpAddress_example" # String | IP address (optional)
$Sender = "Sender_example" # String | Sender (optional)

# Does inbox exist
try {
     $Result = Invoke-DoesInboxExist -EmailAddress $EmailAddress -AllowCatchAll $AllowCatchAll -IpAddress $IpAddress -Sender $Sender
} catch {
...
<a name="Invoke-DoesInboxHaveAutomations"></a>
# **Invoke-DoesInboxHaveAutomations**
> void Invoke-DoesInboxHaveAutomations<br>
...
# Does inbox have automations
try {
     $Result = Invoke-DoesInboxHaveAutomations
} catch {
    Write-Host ("Exception occured when calling Invoke-DoesInboxHaveAutomations: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
$Search = "Search_example" # String | Optionally filter by search words partial matching name and email address (optional)
...
<a name="Get-OrCreateInboxPlusAddress"></a>
# **Get-OrCreateInboxPlusAddress**
> PlusAddressDto Get-OrCreateInboxPlusAddress<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-InboxId] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-FullAddress] <String><br>
...
$InboxId = "InboxId_example" # String | ID of the inbox you want to target
$FullAddress = "FullAddress_example" # String | Full recipient address including +suffix. Example: `inbox+alias@domain.com`

# Get or create a plus address by full address
try {
     $Result = Get-OrCreateInboxPlusAddress -InboxId $InboxId -FullAddress $FullAddress
} catch {
    Write-Host ("Exception occured when calling Get-OrCreateInboxPlusAddress: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **InboxId** | [**String**](String)| ID of the inbox you want to target | 
...
<a name="Get-OrCreatePlusAddressByFullAddress"></a>
# **Get-OrCreatePlusAddressByFullAddress**
> PlusAddressDto Get-OrCreatePlusAddressByFullAddress<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-FullAddress] <String><br>
...
# Get or create a plus address by full address without inbox ID
try {
     $Result = Get-OrCreatePlusAddressByFullAddress -FullAddress $FullAddress
} catch {
    Write-Host ("Exception occured when calling Get-OrCreatePlusAddressByFullAddress: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Import-EmailIntoInbox"></a>
# **Import-EmailIntoInbox**
> Email Import-EmailIntoInbox<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-InboxId] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ImportEmailOptions] <PSCustomObject><br>
...
$InboxId = "InboxId_example" # String | 
$ImportEmailOptions = (Initialize-ImportEmailOptions -RawEmailBase64 "RawEmailBase64_example" -ExternalId "ExternalId_example" -RunPipeline $false -OverrideMessageId $false) # ImportEmailOptions | 

# Import email into inbox from base64 MIME
try {
     $Result = Import-EmailIntoInbox -InboxId $InboxId -ImportEmailOptions $ImportEmailOptions
} catch {
    Write-Host ("Exception occured when calling Import-EmailIntoInbox: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Import-EmailIntoInboxBytes"></a>
# **Import-EmailIntoInboxBytes**
> Email Import-EmailIntoInboxBytes<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-InboxId] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Body] <SystemByte><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ExternalId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-RunPipeline] <System.Nullable[Boolean]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-OverrideMessageId] <System.Nullable[Boolean]><br>
...
$InboxId = "InboxId_example" # String | 
$Body = TODO # SystemByte | 
$ExternalId = "ExternalId_example" # String |  (optional)
$RunPipeline = true # Boolean |  (optional) (default to $false)
$OverrideMessageId = true # Boolean |  (optional) (default to $true)

# Import email into inbox from raw MIME bytes
try {
     $Result = Import-EmailIntoInboxBytes -InboxId $InboxId -Body $Body -ExternalId $ExternalId -RunPipeline $RunPipeline -OverrideMessageId $OverrideMessageId
} catch {
    Write-Host ("Exception occured when calling Import-EmailIntoInboxBytes: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Import-EmailIntoInboxMultipart"></a>
# **Import-EmailIntoInboxMultipart**
> Email Import-EmailIntoInboxMultipart<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-InboxId] <PSCustomObject><br>
...
# Import email into inbox from multipart EML upload
try {
     $Result = Import-EmailIntoInboxMultipart -InboxId $InboxId -File $File -ExternalId $ExternalId -RunPipeline $RunPipeline -OverrideMessageId $OverrideMessageId
} catch {
    Write-Host ("Exception occured when calling Import-EmailIntoInboxMultipart: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
> PageRulesetDto Invoke-ListInboxRulesets<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-InboxId] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Page] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Size] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Sort] <String><br>
