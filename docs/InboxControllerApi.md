...
------------- | ------------- | -------------
[**New-Inbox**](InboxControllerApi#New-Inbox) | **POST** /inboxes | Create an Inbox (email address)
[**New-InboxWithOptions**](InboxControllerApi#New-InboxWithOptions) | **POST** /inboxes/withOptions | Create an inbox with additional options
...
[**Get-Inbox**](InboxControllerApi#Get-Inbox) | **GET** /inboxes/{inboxId} | Get Inbox
...
[**Get-Inboxes**](InboxControllerApi#Get-Inboxes) | **GET** /inboxes | List Inboxes / Email Addresses
...
[**Update-Inbox**](InboxControllerApi#Update-Inbox) | **PATCH** /inboxes/{inboxId} | Update Inbox
...
$Favourite = true # Boolean | Is the inbox favorited. Favouriting inboxes is typically done in the dashboard for quick access or filtering (optional)
$Name = "Name_example" # String | Optional name of the inbox. Displayed in the dashboard for easier search (optional)
...
# Create an Inbox (email address)
try {
     $Result = New-Inbox -AllowTeamAccess $AllowTeamAccess -Description $Description -EmailAddress $EmailAddress -ExpiresAt $ExpiresAt -ExpiresIn $ExpiresIn -Favourite $Favourite -Name $Name -Tags $Tags -UseDomainPool $UseDomainPool
} catch {
...
$CreateInboxDto = (Initialize-CreateInboxDto -AllowTeamAccess $false -Description "Description_example" -EmailAddress "EmailAddress_example" -ExpiresAt Get-Date -ExpiresIn 123 -Favourite $false -Name "Name_example" -Tags @("Tags_example") -UseDomainPool $false) # CreateInboxDto | createInboxDto
