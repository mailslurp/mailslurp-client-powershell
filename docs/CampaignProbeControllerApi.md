...
------------- | ------------- | -------------
[**Compare-CampaignProbeRuns**](CampaignProbeControllerApi#Compare-CampaignProbeRuns) | **GET** /campaign-probe/probes/{probeId}/runs/{runId}/compare/{otherRunId} | Compare two campaign probe runs
...
[**Get-CampaignProbeRun**](CampaignProbeControllerApi#Get-CampaignProbeRun) | **GET** /campaign-probe/probes/{probeId}/runs/{runId} | Get campaign probe run
...
<a name="Compare-CampaignProbeRuns"></a>
# **Compare-CampaignProbeRuns**
> CampaignProbeRunComparisonDto Compare-CampaignProbeRuns<br>
...
# Compare two campaign probe runs
try {
     $Result = Compare-CampaignProbeRuns -ProbeId $ProbeId -RunId $RunId -OtherRunId $OtherRunId
} catch {
    Write-Host ("Exception occured when calling Compare-CampaignProbeRuns: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
...
[**CampaignProbeRunComparisonDto**](CampaignProbeRunComparisonDto) (PSCustomObject)
...
<a name="Get-CampaignProbeRun"></a>
# **Get-CampaignProbeRun**
> CampaignProbeRunDto Get-CampaignProbeRun<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ProbeId] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-RunId] <PSCustomObject><br>
...
# Get campaign probe run
try {
     $Result = Get-CampaignProbeRun -ProbeId $ProbeId -RunId $RunId
} catch {
    Write-Host ("Exception occured when calling Get-CampaignProbeRun: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
