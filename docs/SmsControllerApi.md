...
[**Get-SmsCodes**](SmsControllerApi#Get-SmsCodes) | **POST** /sms/{smsId}/codes | Extract verification codes from an SMS
...
[**Invoke-MarkAllSmsAsRead**](SmsControllerApi#Invoke-MarkAllSmsAsRead) | **PATCH** /sms/read | Mark all SMS messages as read or unread
[**Invoke-MarkSmsAsRead**](SmsControllerApi#Invoke-MarkSmsAsRead) | **PATCH** /sms/{smsId}/read | Mark an SMS as read or unread
...
<a name="Get-SmsCodes"></a>
# **Get-SmsCodes**
> ExtractCodesResult Get-SmsCodes<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-SmsId] <PSCustomObject><br>
...
$SmsId = "SmsId_example" # String | ID of SMS to extract codes from
...
# Extract verification codes from an SMS
try {
     $Result = Get-SmsCodes -SmsId $SmsId -ExtractCodesOptions $ExtractCodesOptions
} catch {
    Write-Host ("Exception occured when calling Get-SmsCodes: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **SmsId** | [**String**](String)| ID of SMS to extract codes from | 
...
<a name="Invoke-MarkAllSmsAsRead"></a>
# **Invoke-MarkAllSmsAsRead**
> void Invoke-MarkAllSmsAsRead<br>
...
$Read = true # Boolean |  (optional) (default to $true)
$PhoneNumberId = "PhoneNumberId_example" # String |  (optional)

# Mark all SMS messages as read or unread
try {
     $Result = Invoke-MarkAllSmsAsRead -Read $Read -PhoneNumberId $PhoneNumberId
} catch {
    Write-Host ("Exception occured when calling Invoke-MarkAllSmsAsRead: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Invoke-MarkSmsAsRead"></a>
# **Invoke-MarkSmsAsRead**
> SmsDto Invoke-MarkSmsAsRead<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-SmsId] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Read] <System.Nullable[Boolean]><br>
...
# Mark an SMS as read or unread
try {
     $Result = Invoke-MarkSmsAsRead -SmsId $SmsId -Read $Read
} catch {
    Write-Host ("Exception occured when calling Invoke-MarkSmsAsRead: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
