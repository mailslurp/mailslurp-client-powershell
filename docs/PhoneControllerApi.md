...
[**Test-PhoneNumberSendSms**](PhoneControllerApi#Test-PhoneNumberSendSms) | **POST** /phone/numbers/{phoneNumberId}/test | 
...
try {
     $Result = Test-PhoneNumberSendSms -PhoneNumberId $PhoneNumberId -TestPhoneNumberOptions $TestPhoneNumberOptions
} catch {
