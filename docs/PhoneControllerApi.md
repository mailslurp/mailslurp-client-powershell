...
$CreatePhoneNumberOptions = (Initialize-CreatePhoneNumberOptions -PhoneCountry "US" -Name "Name_example" -Description "Description_example" -Schedule "MONTHLY" -PhoneNumberEndpointOverride "PhoneNumberEndpointOverride_example" -PhoneNumberVariant "LOCAL") # CreatePhoneNumberOptions | 
