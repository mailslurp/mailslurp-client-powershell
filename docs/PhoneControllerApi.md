...
[**Add-PhoneNumberTags**](PhoneControllerApi#Add-PhoneNumberTags) | **POST** /phone/numbers/{phoneNumberId}/tags | Add phone number tags
...
[**Get-PhoneNumberTags**](PhoneControllerApi#Get-PhoneNumberTags) | **GET** /phone/numbers/{phoneNumberId}/tags | Get phone number tags
...
[**Get-PhoneTags**](PhoneControllerApi#Get-PhoneTags) | **GET** /phone/tags | Get phone tags
...
[**Remove-PhoneNumberTags**](PhoneControllerApi#Remove-PhoneNumberTags) | **DELETE** /phone/numbers/{phoneNumberId}/tags | Remove phone number tags
...
[**Set-PhoneNumberTags**](PhoneControllerApi#Set-PhoneNumberTags) | **PUT** /phone/numbers/{phoneNumberId}/tags | Set phone number tags
...
<a name="Add-PhoneNumberTags"></a>
# **Add-PhoneNumberTags**
> PhoneNumberDto Add-PhoneNumberTags<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-PhoneNumberId] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-PhoneNumberTagsOptions] <PSCustomObject><br>
...
$PhoneNumberTagsOptions = (Initialize-PhoneNumberTagsOptions -Tags @("Tags_example")) # PhoneNumberTagsOptions | 

# Add phone number tags
try {
     $Result = Add-PhoneNumberTags -PhoneNumberId $PhoneNumberId -PhoneNumberTagsOptions $PhoneNumberTagsOptions
} catch {
    Write-Host ("Exception occured when calling Add-PhoneNumberTags: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
$CreatePhoneNumberOptions = (Initialize-CreatePhoneNumberOptions -PhoneCountry "US" -Name "Name_example" -Description "Description_example" -Tags @("Tags_example") -Schedule "MONTHLY" -PhoneNumberEndpointOverride "PhoneNumberEndpointOverride_example" -PhoneNumberVariant "LOCAL" -PhoneProvider "TWILIO" -PhoneLineFilter "ANY") # CreatePhoneNumberOptions | 
...
<a name="Get-PhoneNumberTags"></a>
# **Get-PhoneNumberTags**
> String[] Get-PhoneNumberTags<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-PhoneNumberId] <PSCustomObject><br>
...
# Get phone number tags
try {
     $Result = Get-PhoneNumberTags -PhoneNumberId $PhoneNumberId
} catch {
    Write-Host ("Exception occured when calling Get-PhoneNumberTags: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
$Tag = @("Inner_example") # String[] | Optional tags to filter by. A phone must include all provided tags (optional)
 ...
 **Tag** | [**String[]**](String)| Optional tags to filter by. A phone must include all provided tags | [optional] 
...
<a name="Get-PhoneTags"></a>
# **Get-PhoneTags**
> String[] Get-PhoneTags<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Search] <String><br>
...
# Get phone tags
try {
     $Result = Get-PhoneTags -Search $Search
} catch {
    Write-Host ("Exception occured when calling Get-PhoneTags: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Remove-PhoneNumberTags"></a>
# **Remove-PhoneNumberTags**
> PhoneNumberDto Remove-PhoneNumberTags<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-PhoneNumberId] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-PhoneNumberTagsOptions] <PSCustomObject><br>
...
# Remove phone number tags
try {
     $Result = Remove-PhoneNumberTags -PhoneNumberId $PhoneNumberId -PhoneNumberTagsOptions $PhoneNumberTagsOptions
} catch {
    Write-Host ("Exception occured when calling Remove-PhoneNumberTags: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Set-PhoneNumberTags"></a>
# **Set-PhoneNumberTags**
> PhoneNumberDto Set-PhoneNumberTags<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-PhoneNumberId] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-PhoneNumberTagsOptions] <PSCustomObject><br>
...
# Set phone number tags
try {
     $Result = Set-PhoneNumberTags -PhoneNumberId $PhoneNumberId -PhoneNumberTagsOptions $PhoneNumberTagsOptions
} catch {
    Write-Host ("Exception occured when calling Set-PhoneNumberTags: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
