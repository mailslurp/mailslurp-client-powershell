...
[**Invoke-ExtractAttachmentText**](AttachmentControllerApi#Invoke-ExtractAttachmentText) | **POST** /attachments/{attachmentId}/text | Extract text from an attachment
...
<a name="Invoke-ExtractAttachmentText"></a>
# **Invoke-ExtractAttachmentText**
> ExtractAttachmentTextResult Invoke-ExtractAttachmentText<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-AttachmentId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ExtractAttachmentTextOptions] <PSCustomObject><br>
...
$AttachmentId = "AttachmentId_example" # String | ID of attachment
$ExtractAttachmentTextOptions = (Initialize-ExtractAttachmentTextOptions -Method "AUTO" -AllowFallback $false -MaxBytes 123) # ExtractAttachmentTextOptions |  (optional)

# Extract text from an attachment
try {
     $Result = Invoke-ExtractAttachmentText -AttachmentId $AttachmentId -ExtractAttachmentTextOptions $ExtractAttachmentTextOptions
} catch {
    Write-Host ("Exception occured when calling Invoke-ExtractAttachmentText: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
[**ExtractAttachmentTextResult**](ExtractAttachmentTextResult) (PSCustomObject)
...
$InlineObject2 = (Initialize-inline_object_2 -File 123) # InlineObject2 |  (optional)

# Upload an attachment for sending using a Multipart Form request. Returns an array whose first element is the ID of the uploaded attachment.
try {
     $Result = Invoke-UploadMultipartForm -ContentId $ContentId -ContentType $ContentType -Filename $Filename -ContentTypeHeader $ContentTypeHeader -XFilename $XFilename -XFilenameRaw $XFilenameRaw -XFilesize $XFilesize -InlineObject2 $InlineObject2
} catch {
 ...
 **InlineObject2** | [**InlineObject2**](InlineObject2)|  | [optional] 
