...
[**Get-ReputationItems**](BounceControllerApi#Get-ReputationItems) | **GET** /bounce/reputation-items | Get paginated list of reputation items.
[**Get-TenantReputationFindings**](BounceControllerApi#Get-TenantReputationFindings) | **GET** /bounce/tenant-findings | Get SES tenant reputation findings
[**Get-TenantReputationStatusSummary**](BounceControllerApi#Get-TenantReputationStatusSummary) | **GET** /bounce/tenant-status | Get SES tenant status summary
...
<a name="Get-ReputationItems"></a>
# **Get-ReputationItems**
> PageReputationItems Get-ReputationItems<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Page] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Size] <System.Nullable[Int32]><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Sort] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Since] <System.Nullable[System.DateTime]><br>
...
# Get paginated list of reputation items.
try {
     $Result = Get-ReputationItems -Page $Page -Size $Size -Sort $Sort -Since $Since -Before $Before
} catch {
    Write-Host ("Exception occured when calling Get-ReputationItems: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
[**PageReputationItems**](PageReputationItems) (PSCustomObject)
...
<a name="Get-TenantReputationFindings"></a>
# **Get-TenantReputationFindings**
> TenantReputationFindingsDto Get-TenantReputationFindings<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-AccountRegion] <String><br>
...
$AccountRegion = "US_WEST_2_ACCOUNT_STAGING" # String | Optional account region filter (optional)

# Get SES tenant reputation findings
try {
     $Result = Get-TenantReputationFindings -AccountRegion $AccountRegion
} catch {
    Write-Host ("Exception occured when calling Get-TenantReputationFindings: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
[**TenantReputationFindingsDto**](TenantReputationFindingsDto) (PSCustomObject)
...
<a name="Get-TenantReputationStatusSummary"></a>
# **Get-TenantReputationStatusSummary**
> TenantReputationStatusSummaryDto Get-TenantReputationStatusSummary<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-AccountRegion] <String><br>
...
# Get SES tenant status summary
try {
     $Result = Get-TenantReputationStatusSummary -AccountRegion $AccountRegion
} catch {
    Write-Host ("Exception occured when calling Get-TenantReputationStatusSummary: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
[**TenantReputationStatusSummaryDto**](TenantReputationStatusSummaryDto) (PSCustomObject)
