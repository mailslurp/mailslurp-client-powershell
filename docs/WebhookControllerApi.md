...
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EventType] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Url] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-EventTypeSource] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-IncludeAccountWide] <System.Nullable[Boolean]><br>
...
$EventTypeSource = "INBOX" # String | Webhook source type category such as phone, inbox, aiTranformer (optional)
$IncludeAccountWide = true # Boolean | Include account scope webhooks when passing phoneId, inboxId, or aiTransformerId filters (optional)

# List Webhooks Paginated
try {
     $Result = Get-AllWebhooks -Page $Page -Size $Size -Sort $Sort -SearchFilter $SearchFilter -Since $Since -InboxId $InboxId -AiTransformerId $AiTransformerId -PhoneId $PhoneId -Before $Before -Health $Health -EventType $EventType -Url $Url -EventTypeSource $EventTypeSource -IncludeAccountWide $IncludeAccountWide
} catch {
...
$Health = "HEALTHY" # String | Filter by webhook health (optional)
$EventType = "EMAIL_RECEIVED" # String | Optional event type (optional)
$IncludeAccountWide = true # Boolean | Include account scope inbox webhooks (optional)

# Get paginated webhooks for an Inbox
try {
     $Result = Get-InboxWebhooksPaginated -InboxId $InboxId -Page $Page -Size $Size -Sort $Sort -SearchFilter $SearchFilter -Since $Since -Before $Before -Health $Health -EventType $EventType -IncludeAccountWide $IncludeAccountWide
} catch {
...
$SearchFilter = "SearchFilter_example" # String | Optional search filter (optional)
$Health = "HEALTHY" # String | Filter by webhook health (optional)
$IncludeAccountWide = true # Boolean | Include account scope phone webhooks (optional)

# Get paginated webhooks for a phone number
try {
     $Result = Get-PhoneNumberWebhooksPaginated -PhoneId $PhoneId -Page $Page -Size $Size -Sort $Sort -Since $Since -Before $Before -EventType $EventType -SearchFilter $SearchFilter -Health $Health -IncludeAccountWide $IncludeAccountWide
} catch {
