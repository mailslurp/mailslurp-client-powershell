...
[**Get-TestWebhookPayload**](WebhookControllerApi#Get-TestWebhookPayload) | **GET** /webhooks/test | Get test webhook payload example
...
$WebhookOptions = (Initialize-CreateWebhookOptions -BasicAuth (Initialize-BasicAuthOptions -Username "Username_example" -Password "Password_example") -Name "Name_example" -Url "Url_example") # CreateWebhookOptions | webhookOptions
...
> WebhookPayload Get-TestWebhookPayload<br>
