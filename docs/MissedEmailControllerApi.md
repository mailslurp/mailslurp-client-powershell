...
$InboxId = "InboxId_example" # String | Optional inbox ID filter
$Timeout = 987 # Int64 | Optional timeout milliseconds
...
# Wait for Nth missed email
try {
     $Result = Wait-ForNthMissedEmail -InboxId $InboxId -Timeout $Timeout -Index $Index
} catch {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **InboxId** | [**String**](String)| Optional inbox ID filter | 
