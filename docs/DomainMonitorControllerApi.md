...
------------- | ------------- | -------------
[**Compare-DomainMonitorRuns**](DomainMonitorControllerApi#Compare-DomainMonitorRuns) | **GET** /domain-monitor/monitors/{monitorId}/runs/{runId}/compare/{otherRunId} | Compare two monitor runs
...
[**Get-DomainMonitorAuthStack**](DomainMonitorControllerApi#Get-DomainMonitorAuthStack) | **GET** /domain-monitor/monitors/{monitorId}/auth-stack | Get current auth stack for monitor domain
...
[**Get-DomainMonitorRun**](DomainMonitorControllerApi#Get-DomainMonitorRun) | **GET** /domain-monitor/monitors/{monitorId}/runs/{runId} | Get monitor run
...
[**Get-DomainMonitorSummary**](DomainMonitorControllerApi#Get-DomainMonitorSummary) | **GET** /domain-monitor/monitors/{monitorId}/summary | Get domain monitor summary
...
<a name="Compare-DomainMonitorRuns"></a>
# **Compare-DomainMonitorRuns**
> DomainMonitorRunComparisonDto Compare-DomainMonitorRuns<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-MonitorId] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-RunId] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-OtherRunId] <PSCustomObject><br>
...
$OtherRunId = "OtherRunId_example" # String | 

# Compare two monitor runs
try {
     $Result = Compare-DomainMonitorRuns -MonitorId $MonitorId -RunId $RunId -OtherRunId $OtherRunId
} catch {
    Write-Host ("Exception occured when calling Compare-DomainMonitorRuns: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
 ...
 **RunId** | [**String**](String)|  | 
 **OtherRunId** | [**String**](String)|  | 

### Return type

[**DomainMonitorRunComparisonDto**](DomainMonitorRunComparisonDto) (PSCustomObject)
...
<a name="Get-DomainMonitorAuthStack"></a>
# **Get-DomainMonitorAuthStack**
> CheckEmailAuthStackResults Get-DomainMonitorAuthStack<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-MonitorId] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-DkimSelector] <String><br>
...
$MonitorId = "MonitorId_example" # String | 
$DkimSelector = "DkimSelector_example" # String |  (optional)

# Get current auth stack for monitor domain
try {
     $Result = Get-DomainMonitorAuthStack -MonitorId $MonitorId -DkimSelector $DkimSelector
} catch {
    Write-Host ("Exception occured when calling Get-DomainMonitorAuthStack: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-DomainMonitorRun"></a>
# **Get-DomainMonitorRun**
> DomainMonitorRunDto Get-DomainMonitorRun<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-MonitorId] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-RunId] <PSCustomObject><br>
...
# Get monitor run
try {
     $Result = Get-DomainMonitorRun -MonitorId $MonitorId -RunId $RunId
} catch {
    Write-Host ("Exception occured when calling Get-DomainMonitorRun: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a name="Get-DomainMonitorSummary"></a>
# **Get-DomainMonitorSummary**
> DomainMonitorSummaryDto Get-DomainMonitorSummary<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-MonitorId] <PSCustomObject><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-DkimSelector] <String><br>
...
# Get domain monitor summary
try {
     $Result = Get-DomainMonitorSummary -MonitorId $MonitorId -DkimSelector $DkimSelector
} catch {
    Write-Host ("Exception occured when calling Get-DomainMonitorSummary: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
[**DomainMonitorSummaryDto**](DomainMonitorSummaryDto) (PSCustomObject)
