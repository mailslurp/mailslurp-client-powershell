...
$ReplyToAliasEmailOptions = (Initialize-ReplyToAliasEmailOptions -Attachments @("Attachments_example") -Body "Body_example" -Charset "Charset_example" -IsHTML $false -SendStrategy "SINGLE_MESSAGE" -Template "Template_example" -TemplateVariables "TODO") # ReplyToAliasEmailOptions | replyToAliasEmailOptions
