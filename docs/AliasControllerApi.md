...
$ReplyToAliasEmailOptions = (Initialize-ReplyToAliasEmailOptions -Body "Body_example" -Charset "Charset_example" -Attachments @("Attachments_example") -TemplateVariables "TODO" -Template "Template_example" -SendStrategy "SINGLE_MESSAGE" -UseInboxName $false -Html $false) # ReplyToAliasEmailOptions | 
