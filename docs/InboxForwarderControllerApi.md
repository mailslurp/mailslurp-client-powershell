...
$CreateInboxForwarderOptions = (Initialize-CreateInboxForwarderOptions -Field "RECIPIENTS" -ForwardToRecipients @("ForwardToRecipients_example") -Match "Match_example") # CreateInboxForwarderOptions | createInboxForwarderOptions
...
# List inbox forwarders
try {
     $Result = Get-InboxForwarders -Before $Before -InboxId $InboxId -Page $Page -SearchFilter $SearchFilter -Since $Since -Size $Size -Sort $Sort
} catch {
...
$TestNewInboxForwarderOptions = (Initialize-TestNewInboxForwarderOptions -InboxForwarderTestOptions  -CreateInboxForwarderOptions (Initialize-CreateInboxForwarderOptions -Field "RECIPIENTS" -ForwardToRecipients @("ForwardToRecipients_example") -Match "Match_example")) # TestNewInboxForwarderOptions | testNewInboxForwarderOptions
