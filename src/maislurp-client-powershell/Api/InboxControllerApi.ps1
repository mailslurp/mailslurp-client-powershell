...
function New-InboxRuleset {
    ...
    Process {
        ...
        if (!$CreateRulesetOptions) {
            throw "Error! The required parameter `CreateRulesetOptions` missing when calling createInboxRuleset."
        }
...
function Invoke-DoesInboxExist {
    ...
    Process {
        ...
        if ($Sender) {
            $LocalVarQueryParameters['sender'] = $Sender
        }
...
None
#>
function Invoke-DoesInboxHaveAutomations {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Invoke-DoesInboxHaveAutomations' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $Configuration = Get-Configuration
        $LocalVarUri = '/inboxes/automations'
...
function Get-AllInboxes {
    ...
    Process {
        ...
        if ($InboxFunction) {
            $LocalVarQueryParameters['inboxFunction'] = $InboxFunction
        }
...
PageInboxProjection
#>
function Get-AllInboxesOffsetPaginated {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [System.Nullable[Int32]]
    ...
    Process {
        'Calling method: Get-AllInboxesOffsetPaginated' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/inboxes/offset-paginated'
...
function Get-AllPlusAddresses {
    ...
    Process {
        'Calling method: Get-AllPlusAddresses' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/inboxes/plus-addresses'
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "PagePlusAddressProjection" `
                                -IsBodyNullable $false
...
function Get-ImapAccess {
    ...
    Process {
        'Calling method: Get-ImapAccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
String
#>
function Get-ImapSmtpAccessEnv {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Get-ImapSmtpAccessEnv' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/inboxes/imap-smtp-access/env'
...
#>
function Get-ImapSmtpAccessServers {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Get-ImapSmtpAccessServers' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/inboxes/imap-smtp-access/servers'
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "ImapSmtpAccessServers" `
                                -IsBodyNullable $false
...
function Get-InboxPlusAddress {
    ...
    Process {
        'Calling method: Get-InboxPlusAddress' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/inboxes/{inboxId}/plus-addresses/{plusAddressId}'
        if (!$PlusAddressId) {
            throw "Error! The required parameter `PlusAddressId` missing when calling getInboxPlusAddress."
        }
        $LocalVarUri = $LocalVarUri.replace('{plusAddressId}', $PlusAddressId)
        if (!$InboxId) {
            throw "Error! The required parameter `InboxId` missing when calling getInboxPlusAddress."
        }
        $LocalVarUri = $LocalVarUri.replace('{inboxId}', $InboxId)
...
PlusAddressDto
#>
function Get-InboxPlusAddressById {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Get-InboxPlusAddressById' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/inboxes/plus-addresses/{plusAddressId}'
        if (!$PlusAddressId) {
            throw "Error! The required parameter `PlusAddressId` missing when calling getInboxPlusAddressById."
        }
        $LocalVarUri = $LocalVarUri.replace('{plusAddressId}', $PlusAddressId)
...
PageEmailPreview
#>
function Get-InboxPlusAddressEmails {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-InboxPlusAddressEmails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/inboxes/{inboxId}/plus-addresses/emails'
        if (!$InboxId) {
            throw "Error! The required parameter `InboxId` missing when calling getInboxPlusAddressEmails."
        }
        $LocalVarUri = $LocalVarUri.replace('{inboxId}', $InboxId)

        if (!$PlusAddress) {
            throw "Error! The required parameter `PlusAddress` missing when calling getInboxPlusAddressEmails."
        }
        $LocalVarQueryParameters['plusAddress'] = $PlusAddress
...
PageEmailPreview
#>
function Get-InboxPlusAddressEmailsForPlusAddressId {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Get-InboxPlusAddressEmailsForPlusAddressId' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/inboxes/{inboxId}/plus-addresses/{plusAddressId}/emails'
        if (!$PlusAddressId) {
            throw "Error! The required parameter `PlusAddressId` missing when calling getInboxPlusAddressEmailsForPlusAddressId."
        }
        $LocalVarUri = $LocalVarUri.replace('{plusAddressId}', $PlusAddressId)
        if (!$InboxId) {
            throw "Error! The required parameter `InboxId` missing when calling getInboxPlusAddressEmailsForPlusAddressId."
        }
        $LocalVarUri = $LocalVarUri.replace('{inboxId}', $InboxId)
...
PagePlusAddressProjection
#>
function Get-InboxPlusAddresses {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Get-InboxPlusAddresses' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/inboxes/{inboxId}/plus-addresses'
        if (!$InboxId) {
            throw "Error! The required parameter `InboxId` missing when calling getInboxPlusAddresses."
        }
        $LocalVarUri = $LocalVarUri.replace('{inboxId}', $InboxId)
...
function Get-InboxSentCount {
    ...
    Process {
        'Calling method: Get-InboxSentCount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/inboxes/{inboxId}/sent/count'
        if (!$InboxId) {
            throw "Error! The required parameter `InboxId` missing when calling getInboxSentCount."
        }
        $LocalVarUri = $LocalVarUri.replace('{inboxId}', $InboxId)
...
PageInboxTags
#>
function Get-InboxTagsPaginated {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [System.Nullable[Int32]]
    ...
    Process {
        'Calling method: Get-InboxTagsPaginated' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/inboxes/tags/paginated'
...
function Get-InboxesByTag {
    ...
    Process {
        'Calling method: Get-InboxesByTag' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/inboxes/tags/inboxes'
        ...
        if (!$Tag) {
            throw "Error! The required parameter `Tag` missing when calling getInboxesByTag."
        }
        $LocalVarQueryParameters['tag'] = $Tag
...
PlusAddressDto
#>
function Get-OrCreateInboxPlusAddress {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Get-OrCreateInboxPlusAddress' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/inboxes/{inboxId}/plus-addresses/get-or-create'
        if (!$InboxId) {
            throw "Error! The required parameter `InboxId` missing when calling getOrCreateInboxPlusAddress."
        }
        $LocalVarUri = $LocalVarUri.replace('{inboxId}', $InboxId)

        if (!$FullAddress) {
            throw "Error! The required parameter `FullAddress` missing when calling getOrCreateInboxPlusAddress."
        }
        $LocalVarQueryParameters['fullAddress'] = $FullAddress
...
PlusAddressDto
#>
function Get-OrCreatePlusAddressByFullAddress {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-OrCreatePlusAddressByFullAddress' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/inboxes/get-or-create-plus-address'

        if (!$FullAddress) {
            throw "Error! The required parameter `FullAddress` missing when calling getOrCreatePlusAddressByFullAddress."
        }
        $LocalVarQueryParameters['fullAddress'] = $FullAddress
...
function Get-Outboxes {
    ...
    Process {
        'Calling method: Get-Outboxes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-SmtpAccess {
    ...
    Process {
        'Calling method: Get-SmtpAccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/inboxes/smtp-access'
...
Email
#>
function Import-EmailIntoInbox {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Import-EmailIntoInbox' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/inboxes/{inboxId}/emails/import'
        if (!$InboxId) {
            throw "Error! The required parameter `InboxId` missing when calling importEmailIntoInbox."
        }
        $LocalVarUri = $LocalVarUri.replace('{inboxId}', $InboxId)

        if (!$ImportEmailOptions) {
            throw "Error! The required parameter `ImportEmailOptions` missing when calling importEmailIntoInbox."
        }

        $LocalVarBodyParameter = $ImportEmailOptions | ConvertTo-Json -Depth 100
...
Email
#>
function Import-EmailIntoInboxBytes {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Import-EmailIntoInboxBytes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        # HTTP header 'Content-Type'
        $LocalVarContentTypes = @('application/octet-stream', 'message/rfc822')

        $LocalVarUri = '/inboxes/{inboxId}/emails/import/raw'
        if (!$InboxId) {
            throw "Error! The required parameter `InboxId` missing when calling importEmailIntoInboxBytes."
        }
        $LocalVarUri = $LocalVarUri.replace('{inboxId}', $InboxId)

        if ($ExternalId) {
            $LocalVarQueryParameters['externalId'] = $ExternalId
        }

        if ($RunPipeline) {
            $LocalVarQueryParameters['runPipeline'] = $RunPipeline
        }

        if ($OverrideMessageId) {
            $LocalVarQueryParameters['overrideMessageId'] = $OverrideMessageId
        }

        if (!$Body) {
            throw "Error! The required parameter `Body` missing when calling importEmailIntoInboxBytes."
        }
...
Email
#>
function Import-EmailIntoInboxMultipart {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Import-EmailIntoInboxMultipart' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/inboxes/{inboxId}/emails/import/multipart'
        if (!$InboxId) {
            throw "Error! The required parameter `InboxId` missing when calling importEmailIntoInboxMultipart."
        }
        $LocalVarUri = $LocalVarUri.replace('{inboxId}', $InboxId)
        ...
        if (!$File) {
            throw "Error! The required parameter `File` missing when calling importEmailIntoInboxMultipart."
        }
...
#>
function Invoke-IsEmailAddressAvailable {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-IsEmailAddressAvailable' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/inboxes/available'

        if (!$EmailAddress) {
            throw "Error! The required parameter `EmailAddress` missing when calling isEmailAddressAvailable."
        }
        $LocalVarQueryParameters['emailAddress'] = $EmailAddress
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'POST' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "EmailAvailableResult" `
                                -IsBodyNullable $false
...
.PARAMETER SearchInboxesOptions
No description available.
...
function Search-Inboxes {
    ...
    Process {
        'Calling method: Search-Inboxes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/inboxes/search'

        if (!$SearchInboxesOptions) {
            throw "Error! The required parameter `SearchInboxesOptions` missing when calling searchInboxes."
        }

        $LocalVarBodyParameter = $SearchInboxesOptions | ConvertTo-Json -Depth 100
...
.PARAMETER UpdateImapAccessOptions
No description available.
...
function Update-ImapAccess {
    ...
    Process {
        'Calling method: Update-ImapAccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!$UpdateImapAccessOptions) {
            throw "Error! The required parameter `UpdateImapAccessOptions` missing when calling updateImapAccess."
        }

        $LocalVarBodyParameter = $UpdateImapAccessOptions | ConvertTo-Json -Depth 100
...
.PARAMETER UpdateSmtpAccessOptions
No description available.
...
function Update-SmtpAccess {
    ...
    Process {
        'Calling method: Update-SmtpAccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!$UpdateSmtpAccessOptions) {
            throw "Error! The required parameter `UpdateSmtpAccessOptions` missing when calling updateSmtpAccess."
        }

        $LocalVarBodyParameter = $UpdateSmtpAccessOptions | ConvertTo-Json -Depth 100
