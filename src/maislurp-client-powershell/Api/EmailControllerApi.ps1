...
#>
function Invoke-CheckEmailAudit1 {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-CheckEmailAudit1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/emails/{emailId}/check-email-audit'
        if (!$EmailId) {
            throw "Error! The required parameter `EmailId` missing when calling checkEmailAudit1."
        }
        $LocalVarUri = $LocalVarUri.replace('{emailId}', $EmailId)
...
EmailAuditDto
#>
function New-EmailAuditForEmail {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: New-EmailAuditForEmail' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/emails/{emailId}/audit'
        if (!$EmailId) {
            throw "Error! The required parameter `EmailId` missing when calling createEmailAuditForEmail."
        }
        $LocalVarUri = $LocalVarUri.replace('{emailId}', $EmailId)
...
function Get-EmailCodes {
    ...
    Process {
        'Calling method: Get-EmailCodes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/emails/{emailId}/codes'
        if (!$EmailId) {
            throw "Error! The required parameter `EmailId` missing when calling getEmailCodes."
        }
        $LocalVarUri = $LocalVarUri.replace('{emailId}', $EmailId)
...
function Get-EmailSignature {
    ...
    Process {
        'Calling method: Get-EmailSignature' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/emails/{emailId}/signature'
        if (!$EmailId) {
            throw "Error! The required parameter `EmailId` missing when calling getEmailSignature."
        }
        $LocalVarUri = $LocalVarUri.replace('{emailId}', $EmailId)
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "EmailSignatureParseResult" `
                                -IsBodyNullable $false
