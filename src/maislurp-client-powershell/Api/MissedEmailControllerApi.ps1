...
function Wait-ForNthMissedEmail {
    ...
    Process {
        ...
        if (!$InboxId) {
            throw "Error! The required parameter `InboxId` missing when calling waitForNthMissedEmail."
        }
        $LocalVarUri = $LocalVarUri.replace('{inboxId}', $InboxId)
        if (!$Timeout) {
            throw "Error! The required parameter `Timeout` missing when calling waitForNthMissedEmail."
        }
        $LocalVarUri = $LocalVarUri.replace('{timeout}', $Timeout)
