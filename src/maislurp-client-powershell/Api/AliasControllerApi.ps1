...
function Get-AliasThreads {
    ...
    Process {
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "PageAliasThreadProjection" `
                                -IsBodyNullable $false
...
function Get-Thread {
    ...
    Process {
        ...
        $LocalVarUri = '/aliases/threads/{threadId}'
        if (!$ThreadId) {
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "AliasThreadProjection" `
                                -IsBodyNullable $false
...
function Get-ThreadsPaginated {
    ...
    Process {
        'Calling method: Get-ThreadsPaginated' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
