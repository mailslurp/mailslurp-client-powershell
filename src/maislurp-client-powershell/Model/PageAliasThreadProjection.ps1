...
PageAliasThreadProjection<PSCustomObject>
#>

function Initialize-PageAliasThreadProjection {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PageAliasThreadProjection' | Write-Debug
...
Convert from JSON to PageAliasThreadProjection<PSCustomObject>
...
PageAliasThreadProjection<PSCustomObject>
#>
function ConvertFrom-JsonToPageAliasThreadProjection {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PageAliasThreadProjection' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageAliasThreadProjection
