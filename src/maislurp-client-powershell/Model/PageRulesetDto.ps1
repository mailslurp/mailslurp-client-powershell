...
PageRulesetDto<PSCustomObject>
#>

function Initialize-PageRulesetDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PageRulesetDto' | Write-Debug
...
Convert from JSON to PageRulesetDto<PSCustomObject>
...
PageRulesetDto<PSCustomObject>
#>
function ConvertFrom-JsonToPageRulesetDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PageRulesetDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageRulesetDto
