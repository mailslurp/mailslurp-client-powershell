...
function ConvertFrom-JsonToInvokeTransformerOptions {
    ...
    Process {
        ...
        $AllProperties = ("aiTransformId", "aiTransformMappingId", "rawInput", "entityId", "entityType", "rawConditions", "rawInstructions", "rawOutputSchema", "contentSelector", "saveResults")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "saveResults"))) { #optional property not found
            $SaveResults = $null
        } else {
            $SaveResults = $JsonParameters.PSobject.Properties["saveResults"].value
        }
