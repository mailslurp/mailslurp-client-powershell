...
PageOptInIdentityProjection<PSCustomObject>
#>

function Initialize-PageOptInIdentityProjection {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PageOptInIdentityProjection' | Write-Debug
...
Convert from JSON to PageOptInIdentityProjection<PSCustomObject>
...
PageOptInIdentityProjection<PSCustomObject>
#>
function ConvertFrom-JsonToPageOptInIdentityProjection {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PageOptInIdentityProjection' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageOptInIdentityProjection
