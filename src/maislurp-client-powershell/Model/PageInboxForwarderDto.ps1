...
function Initialize-PageInboxForwarderDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PageInboxForwarderDto' | Write-Debug
...
Convert from JSON to PageInboxForwarderDto<PSCustomObject>
...
PageInboxForwarderDto<PSCustomObject>
#>
function ConvertFrom-JsonToPageInboxForwarderDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PageInboxForwarderDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageInboxForwarderDto
