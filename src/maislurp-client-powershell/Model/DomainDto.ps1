...
.PARAMETER DuplicateRecordsMessage
If the domain is duplicate records.
.PARAMETER HasDuplicateRecords
...
function Initialize-DomainDto {
    ...
    Process {
        ...
        if ($HasDuplicateRecords -eq $null) {
            throw "invalid value for 'HasDuplicateRecords', 'HasDuplicateRecords' cannot be null."
        }
...
function ConvertFrom-JsonToDomainDto {
    ...
    Process {
        ...
        $AllProperties = ("id", "userId", "domain", "verificationToken", "dkimTokens", "duplicateRecordsMessage", "hasDuplicateRecords", "missingRecordsMessage", "hasMissingRecords", "isVerified", "domainNameRecords", "catchAllInboxId", "createdAt", "updatedAt", "domainType")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "hasDuplicateRecords"))) {
            throw "Error! JSON cannot be serialized due to the required property 'hasDuplicateRecords' missing."
        } else {
            $HasDuplicateRecords = $JsonParameters.PSobject.Properties["hasDuplicateRecords"].value
        }
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "duplicateRecordsMessage"))) { #optional property not found
            $DuplicateRecordsMessage = $null
        } else {
            $DuplicateRecordsMessage = $JsonParameters.PSobject.Properties["duplicateRecordsMessage"].value
        }
