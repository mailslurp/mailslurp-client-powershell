...
AIMappingMatchOption<PSCustomObject>
#>

function Initialize-AIMappingMatchOption {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("SUBJECT", "TO", "BCC", "CC", "FROM", "HEADERS", "FILENAME", "SMS")]
        [String]
        ${Field},
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => AIMappingMatchOption' | Write-Debug
...
Convert from JSON to AIMappingMatchOption<PSCustomObject>
...
AIMappingMatchOption<PSCustomObject>
#>
function ConvertFrom-JsonToAIMappingMatchOption {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => AIMappingMatchOption' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AIMappingMatchOption
