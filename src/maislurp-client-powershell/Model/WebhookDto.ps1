...
function ConvertFrom-JsonToWebhookDto {
    ...
    Process {
        ...
        $AllProperties = ("id", "userId", "basicAuth", "name", "phoneId", "inboxId", "requestBodyTemplate", "url", "method", "payloadJsonSchema", "createdAt", "updatedAt", "eventName", "requestHeaders", "ignoreInsecureSslCertificates", "useStaticIpRange", "healthStatus")
