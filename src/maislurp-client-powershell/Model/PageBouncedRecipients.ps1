...
function Initialize-PageBouncedRecipients {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PageBouncedRecipients' | Write-Debug
...
Convert from JSON to PageBouncedRecipients<PSCustomObject>
...
PageBouncedRecipients<PSCustomObject>
#>
function ConvertFrom-JsonToPageBouncedRecipients {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PageBouncedRecipients' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBouncedRecipients
