...
PageEntityAutomationItems<PSCustomObject>
#>

function Initialize-PageEntityAutomationItems {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PageEntityAutomationItems' | Write-Debug
...
Convert from JSON to PageEntityAutomationItems<PSCustomObject>
...
PageEntityAutomationItems<PSCustomObject>
#>
function ConvertFrom-JsonToPageEntityAutomationItems {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PageEntityAutomationItems' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageEntityAutomationItems
