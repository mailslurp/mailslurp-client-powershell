...
function Initialize-PageTrackingPixelProjection {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PageTrackingPixelProjection' | Write-Debug
...
Convert from JSON to PageTrackingPixelProjection<PSCustomObject>
...
PageTrackingPixelProjection<PSCustomObject>
#>
function ConvertFrom-JsonToPageTrackingPixelProjection {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PageTrackingPixelProjection' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageTrackingPixelProjection
