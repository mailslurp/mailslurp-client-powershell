...
GuestPortalUserDto<PSCustomObject>
#>

function Initialize-GuestPortalUserDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => GuestPortalUserDto' | Write-Debug
...
Convert from JSON to GuestPortalUserDto<PSCustomObject>
...
GuestPortalUserDto<PSCustomObject>
#>
function ConvertFrom-JsonToGuestPortalUserDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => GuestPortalUserDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GuestPortalUserDto
        $AllProperties = ("id", "userId", "portalId", "name", "username", "emailAddress", "inboxId", "loginUrl", "createdAt", "updatedAt")
