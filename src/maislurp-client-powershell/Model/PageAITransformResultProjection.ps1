...
PageAITransformResultProjection<PSCustomObject>
#>

function Initialize-PageAITransformResultProjection {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PageAITransformResultProjection' | Write-Debug
...
Convert from JSON to PageAITransformResultProjection<PSCustomObject>
...
PageAITransformResultProjection<PSCustomObject>
#>
function ConvertFrom-JsonToPageAITransformResultProjection {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PageAITransformResultProjection' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageAITransformResultProjection
        $AllProperties = ("content", "pageable", "columns", "totalElements", "totalPages", "last", "numberOfElements", "sort", "first", "size", "number", "empty")
