...
function ConvertFrom-JsonToInboxPreview {
    ...
    Process {
        ...
        $AllProperties = ("id", "domainId", "emailAddress", "createdAt", "favourite", "name", "tags", "teamAccess", "inboxType", "virtualInbox", "expiresAt", "functionsAs", "userId", "description", "accountRegion")
