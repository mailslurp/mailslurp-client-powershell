...
PageConnectorEvents<PSCustomObject>
#>

function Initialize-PageConnectorEvents {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PageConnectorEvents' | Write-Debug
...
Convert from JSON to PageConnectorEvents<PSCustomObject>
...
PageConnectorEvents<PSCustomObject>
#>
function ConvertFrom-JsonToPageConnectorEvents {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PageConnectorEvents' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageConnectorEvents
