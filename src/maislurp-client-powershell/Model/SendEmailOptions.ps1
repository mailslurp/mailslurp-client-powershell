...
function ConvertFrom-JsonToSendEmailOptions {
    ...
    Process {
        ...
        $AllProperties = ("toContacts", "toGroup", "to", "from", "cc", "bcc", "subject", "replyTo", "body", "html", "charset", "attachments", "templateVariables", "template", "sendStrategy", "useInboxName", "addTrackingPixel")
