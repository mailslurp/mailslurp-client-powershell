...
function Initialize-SendEmailOptions {
    ...
    Process {
        ...
        if (!$ToContacts -and $ToContacts.length -gt 10) {
            throw "invalid value for 'ToContacts', number of items must be less than or equal to 10."
        }

        if (!$ToContacts -and $ToContacts.length -lt 0) {
            throw "invalid value for 'ToContacts', number of items must be greater than or equal to 0."
        }

        if (!$To -and $To.length -gt 10) {
            throw "invalid value for 'To', number of items must be less than or equal to 10."
        }

        if (!$To -and $To.length -lt 0) {
            throw "invalid value for 'To', number of items must be greater than or equal to 0."
        }

        if (!$Cc -and $Cc.length -gt 10) {
            throw "invalid value for 'Cc', number of items must be less than or equal to 10."
        }

        if (!$Cc -and $Cc.length -lt 0) {
            throw "invalid value for 'Cc', number of items must be greater than or equal to 0."
        }

        if (!$Bcc -and $Bcc.length -gt 10) {
            throw "invalid value for 'Bcc', number of items must be less than or equal to 10."
        }

        if (!$Bcc -and $Bcc.length -lt 0) {
            throw "invalid value for 'Bcc', number of items must be greater than or equal to 0."
        }
...
function ConvertFrom-JsonToSendEmailOptions {
    ...
    Process {
        ...
        $AllProperties = ("toContacts", "toGroup", "to", "from", "cc", "bcc", "subject", "replyTo", "body", "html", "isHTML", "charset", "attachments", "templateVariables", "template", "sendStrategy", "useInboxName", "addTrackingPixel", "filterBouncedRecipients", "validateEmailAddresses")
