...
function ConvertFrom-JsonToSendEmailOptions {
    ...
    Process {
        ...
        $AllProperties = ("addTrackingPixel", "attachments", "bcc", "body", "cc", "charset", "from", "html", "isHTML", "replyTo", "sendStrategy", "subject", "template", "templateVariables", "to", "toContacts", "toGroup", "useInboxName")
