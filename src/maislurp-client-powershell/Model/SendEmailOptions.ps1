...
function ConvertFrom-JsonToSendEmailOptions {
    ...
    Process {
        ...
        $AllProperties = ("toContacts", "toGroup", "to", "from", "cc", "bcc", "subject", "replyTo", "customHeaders", "body", "html", "isHTML", "charset", "attachments", "templateVariables", "template", "sendStrategy", "useInboxName", "addTrackingPixel", "filterBouncedRecipients", "validateEmailAddresses", "ignoreEmptyRecipients", "isXAmpHtml", "bodyParts")
