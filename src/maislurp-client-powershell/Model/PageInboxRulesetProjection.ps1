...
PageInboxRulesetProjection<PSCustomObject>
#>

function Initialize-PageInboxRulesetProjection {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PageInboxRulesetProjection' | Write-Debug
...
Convert from JSON to PageInboxRulesetProjection<PSCustomObject>
...
PageInboxRulesetProjection<PSCustomObject>
#>
function ConvertFrom-JsonToPageInboxRulesetProjection {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PageInboxRulesetProjection' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageInboxRulesetProjection
