...
function Initialize-PagePhoneNumberProjection {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PagePhoneNumberProjection' | Write-Debug
...
Convert from JSON to PagePhoneNumberProjection<PSCustomObject>
...
PagePhoneNumberProjection<PSCustomObject>
#>
function ConvertFrom-JsonToPagePhoneNumberProjection {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PagePhoneNumberProjection' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PagePhoneNumberProjection
