...
function ConvertFrom-JsonToCreateInboxDto {
    ...
    Process {
        ...
        $AllProperties = ("emailAddress", "domainName", "domainId", "name", "description", "useDomainPool", "tags", "expiresAt", "favourite", "expiresIn", "allowTeamAccess", "inboxType", "virtualInbox", "useShortAddress", "prefix")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "virtualInbox"))) { #optional property not found
            $VirtualInbox = $null
        } else {
            $VirtualInbox = $JsonParameters.PSobject.Properties["virtualInbox"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "useShortAddress"))) { #optional property not found
            $UseShortAddress = $null
        } else {
            $UseShortAddress = $JsonParameters.PSobject.Properties["useShortAddress"].value
        }
