...
function ConvertFrom-JsonToCreateInboxDto {
    ...
    Process {
        ...
        $AllProperties = ("emailAddress", "domainName", "domainId", "name", "description", "useDomainPool", "tags", "expiresAt", "favourite", "expiresIn", "allowTeamAccess", "inboxType", "virtualInbox", "useShortAddress")
