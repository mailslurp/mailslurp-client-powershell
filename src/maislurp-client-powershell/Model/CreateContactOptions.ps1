...
.PARAMETER VerifyEmailAddresses
...
function ConvertFrom-JsonToCreateContactOptions {
    ...
    Process {
        ...
        $AllProperties = ("firstName", "lastName", "company", "emailAddresses", "tags", "metaData", "optOut", "groupId", "verifyEmailAddresses")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "verifyEmailAddresses"))) { #optional property not found
            $VerifyEmailAddresses = $null
        } else {
            $VerifyEmailAddresses = $JsonParameters.PSobject.Properties["verifyEmailAddresses"].value
        }
