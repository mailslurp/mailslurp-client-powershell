...
GenerateTlsReportingRecordResults<PSCustomObject>
#>

function Initialize-GenerateTlsReportingRecordResults {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => GenerateTlsReportingRecordResults' | Write-Debug
...
Convert from JSON to GenerateTlsReportingRecordResults<PSCustomObject>
...
GenerateTlsReportingRecordResults<PSCustomObject>
#>
function ConvertFrom-JsonToGenerateTlsReportingRecordResults {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => GenerateTlsReportingRecordResults' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GenerateTlsReportingRecordResults
