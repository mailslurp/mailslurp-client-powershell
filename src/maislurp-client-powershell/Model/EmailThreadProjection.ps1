...
function ConvertFrom-JsonToEmailThreadProjection {
    ...
    Process {
        ...
        $AllProperties = ("subject", "createdAt", "updatedAt", "unread", "sender", "recipients", "userId", "inboxId", "to", "cc", "bcc", "hasAttachments", "messageCount", "lastBodyExcerpt", "lastTextExcerpt", "lastCreatedAt", "lastFrom", "lastSender", "id", "from")
