...
function ConvertFrom-JsonToEmailThreadProjection {
    ...
    Process {
        ...
        $AllProperties = ("sender", "recipients", "userId", "inboxId", "updatedAt", "createdAt", "to", "cc", "bcc", "hasAttachments", "lastBodyExcerpt", "lastTextExcerpt", "lastCreatedAt", "lastFrom", "lastSender", "messageCount", "unread", "subject", "id", "from")
