...
function ConvertFrom-JsonToEmailThreadProjection {
    ...
    Process {
        ...
        $AllProperties = ("id", "from", "subject", "sender", "recipients", "userId", "inboxId", "updatedAt", "createdAt", "to", "cc", "bcc", "hasAttachments", "unread", "messageCount", "lastBodyExcerpt", "lastTextExcerpt", "lastCreatedAt", "lastFrom", "lastSender")
