...
function ConvertFrom-JsonToEmailThreadProjection {
    ...
    Process {
        ...
        $AllProperties = ("subject", "userId", "inboxId", "sender", "recipients", "updatedAt", "createdAt", "to", "cc", "bcc", "hasAttachments", "lastCreatedAt", "lastFrom", "lastSender", "unread", "messageCount", "lastBodyExcerpt", "lastTextExcerpt", "id", "from")
