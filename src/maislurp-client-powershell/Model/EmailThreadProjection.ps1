...
function ConvertFrom-JsonToEmailThreadProjection {
    ...
    Process {
        ...
        $AllProperties = ("sender", "recipients", "userId", "inboxId", "updatedAt", "createdAt", "to", "cc", "bcc", "hasAttachments", "unread", "messageCount", "lastBodyExcerpt", "lastTextExcerpt", "lastCreatedAt", "lastFrom", "lastSender", "subject", "id", "from")
