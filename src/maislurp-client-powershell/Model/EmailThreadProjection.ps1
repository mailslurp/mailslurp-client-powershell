...
function ConvertFrom-JsonToEmailThreadProjection {
    ...
    Process {
        ...
        $AllProperties = ("id", "from", "subject", "sender", "recipients", "userId", "inboxId", "createdAt", "to", "cc", "bcc", "updatedAt", "hasAttachments", "unread", "messageCount", "lastBodyExcerpt", "lastTextExcerpt", "lastCreatedAt", "lastFrom", "lastSender")
