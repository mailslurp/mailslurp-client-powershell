...
function ConvertFrom-JsonToEmailThreadProjection {
    ...
    Process {
        ...
        $AllProperties = ("sender", "recipients", "userId", "inboxId", "updatedAt", "createdAt", "to", "cc", "bcc", "hasAttachments", "messageCount", "lastBodyExcerpt", "lastTextExcerpt", "lastCreatedAt", "lastFrom", "lastSender", "unread", "subject", "id", "from")
