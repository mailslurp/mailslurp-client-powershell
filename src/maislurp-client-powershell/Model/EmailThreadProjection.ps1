...
function ConvertFrom-JsonToEmailThreadProjection {
    ...
    Process {
        ...
        $AllProperties = ("subject", "updatedAt", "userId", "inboxId", "createdAt", "to", "cc", "bcc", "sender", "recipients", "hasAttachments", "unread", "messageCount", "lastBodyExcerpt", "lastTextExcerpt", "lastCreatedAt", "lastFrom", "lastSender", "id", "from")
