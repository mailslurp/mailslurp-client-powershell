...
OptionalConnectorSyncSettingsDto<PSCustomObject>
#>

function Initialize-OptionalConnectorSyncSettingsDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => OptionalConnectorSyncSettingsDto' | Write-Debug
...
Convert from JSON to OptionalConnectorSyncSettingsDto<PSCustomObject>
...
OptionalConnectorSyncSettingsDto<PSCustomObject>
#>
function ConvertFrom-JsonToOptionalConnectorSyncSettingsDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => OptionalConnectorSyncSettingsDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in OptionalConnectorSyncSettingsDto
