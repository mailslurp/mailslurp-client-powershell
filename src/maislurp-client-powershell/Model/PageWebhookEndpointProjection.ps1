...
PageWebhookEndpointProjection<PSCustomObject>
#>

function Initialize-PageWebhookEndpointProjection {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PageWebhookEndpointProjection' | Write-Debug
...
Convert from JSON to PageWebhookEndpointProjection<PSCustomObject>
...
PageWebhookEndpointProjection<PSCustomObject>
#>
function ConvertFrom-JsonToPageWebhookEndpointProjection {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PageWebhookEndpointProjection' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageWebhookEndpointProjection
