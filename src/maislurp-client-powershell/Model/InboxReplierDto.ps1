...
function ConvertFrom-JsonToInboxReplierDto {
    ...
    Process {
        ...
        $AllProperties = ("id", "inboxId", "name", "field", "match", "replyTo", "subject", "from", "charset", "isHTML", "templateId", "templateVariables", "ignoreReplyTo", "createdAt", "should", "matchOptions")
