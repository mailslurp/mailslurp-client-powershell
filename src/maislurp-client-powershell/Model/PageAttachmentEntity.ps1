...
function Initialize-PageAttachmentEntity {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PageAttachmentEntity' | Write-Debug
...
Convert from JSON to PageAttachmentEntity<PSCustomObject>
...
PageAttachmentEntity<PSCustomObject>
#>
function ConvertFrom-JsonToPageAttachmentEntity {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PageAttachmentEntity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageAttachmentEntity
