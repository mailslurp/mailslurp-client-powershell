...
PageAITransformProjection<PSCustomObject>
#>

function Initialize-PageAITransformProjection {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PageAITransformProjection' | Write-Debug
...
Convert from JSON to PageAITransformProjection<PSCustomObject>
...
PageAITransformProjection<PSCustomObject>
#>
function ConvertFrom-JsonToPageAITransformProjection {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PageAITransformProjection' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageAITransformProjection
