...
function Initialize-PageEmailValidationRequest {
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PageEmailValidationRequest' | Write-Debug
...
Convert from JSON to PageEmailValidationRequest<PSCustomObject>
...
PageEmailValidationRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPageEmailValidationRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PageEmailValidationRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageEmailValidationRequest
