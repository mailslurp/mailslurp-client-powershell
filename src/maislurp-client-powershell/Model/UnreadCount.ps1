...
function Initialize-UnreadCount {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => UnreadCount' | Write-Debug
...
Convert from JSON to UnreadCount<PSCustomObject>
...
UnreadCount<PSCustomObject>
#>
function ConvertFrom-JsonToUnreadCount {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => UnreadCount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UnreadCount
        $AllProperties = ("count")
