...
function Initialize-PageComplaint {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PageComplaint' | Write-Debug
...
Convert from JSON to PageComplaint<PSCustomObject>
...
PageComplaint<PSCustomObject>
#>
function ConvertFrom-JsonToPageComplaint {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PageComplaint' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageComplaint
