...
function Initialize-PageEmailPreview {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PageEmailPreview' | Write-Debug
...
Convert from JSON to PageEmailPreview<PSCustomObject>
...
PageEmailPreview<PSCustomObject>
#>
function ConvertFrom-JsonToPageEmailPreview {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PageEmailPreview' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageEmailPreview
