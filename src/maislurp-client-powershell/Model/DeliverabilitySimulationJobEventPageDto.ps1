...
DeliverabilitySimulationJobEventPageDto<PSCustomObject>
#>

function Initialize-DeliverabilitySimulationJobEventPageDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => DeliverabilitySimulationJobEventPageDto' | Write-Debug
...
Convert from JSON to DeliverabilitySimulationJobEventPageDto<PSCustomObject>
...
DeliverabilitySimulationJobEventPageDto<PSCustomObject>
#>
function ConvertFrom-JsonToDeliverabilitySimulationJobEventPageDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => DeliverabilitySimulationJobEventPageDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DeliverabilitySimulationJobEventPageDto
        $AllProperties = ("job", "content", "page", "size", "totalElements", "totalPages")
