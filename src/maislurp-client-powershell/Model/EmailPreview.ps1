...
function ConvertFrom-JsonToEmailPreview {
    ...
    Process {
        ...
        $AllProperties = ("id", "inboxId", "domainId", "subject", "to", "from", "bcc", "cc", "createdAt", "read", "attachments", "threadId", "messageId", "inReplyTo", "sender", "recipients", "favourite", "bodyPartContentTypes", "plusAddress", "sizeBytes")
