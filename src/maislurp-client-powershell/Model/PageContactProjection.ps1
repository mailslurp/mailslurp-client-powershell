...
function Initialize-PageContactProjection {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PageContactProjection' | Write-Debug
...
Convert from JSON to PageContactProjection<PSCustomObject>
...
PageContactProjection<PSCustomObject>
#>
function ConvertFrom-JsonToPageContactProjection {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PageContactProjection' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageContactProjection
