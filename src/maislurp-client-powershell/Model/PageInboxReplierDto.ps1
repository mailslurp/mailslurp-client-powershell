...
PageInboxReplierDto<PSCustomObject>
#>

function Initialize-PageInboxReplierDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PageInboxReplierDto' | Write-Debug
...
Convert from JSON to PageInboxReplierDto<PSCustomObject>
...
PageInboxReplierDto<PSCustomObject>
#>
function ConvertFrom-JsonToPageInboxReplierDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PageInboxReplierDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageInboxReplierDto
