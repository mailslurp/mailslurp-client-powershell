...
function ConvertFrom-JsonToCreateAliasOptions {
    ...
    Process {
        ...
        $AllProperties = ("emailAddress", "inboxId", "name", "useThreads", "domainId", "verifyEmailAddress")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "verifyEmailAddress"))) { #optional property not found
            $VerifyEmailAddress = $null
        } else {
            $VerifyEmailAddress = $JsonParameters.PSobject.Properties["verifyEmailAddress"].value
        }
