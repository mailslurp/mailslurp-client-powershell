...
GenerateDmarcRecordResults<PSCustomObject>
#>

function Initialize-GenerateDmarcRecordResults {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => GenerateDmarcRecordResults' | Write-Debug
...
Convert from JSON to GenerateDmarcRecordResults<PSCustomObject>
...
GenerateDmarcRecordResults<PSCustomObject>
#>
function ConvertFrom-JsonToGenerateDmarcRecordResults {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => GenerateDmarcRecordResults' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GenerateDmarcRecordResults
