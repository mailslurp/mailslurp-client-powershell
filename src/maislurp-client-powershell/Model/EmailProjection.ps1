...
function ConvertFrom-JsonToEmailProjection {
    ...
    Process {
        ...
        $AllProperties = ("subject", "createdAt", "sender", "recipients", "attachments", "inboxId", "to", "cc", "bcc", "messageId", "domainId", "favourite", "plusAddress", "inReplyTo", "read", "bodyExcerpt", "textExcerpt", "bodyPartContentTypes", "bodyMD5Hash", "teamAccess", "id", "threadId", "from")
