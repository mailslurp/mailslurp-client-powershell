...
function ConvertFrom-JsonToEmailProjection {
    ...
    Process {
        ...
        $AllProperties = ("id", "threadId", "from", "subject", "sender", "recipients", "inboxId", "attachments", "sizeBytes", "createdAt", "to", "cc", "bcc", "messageId", "favourite", "domainId", "plusAddress", "imapUid", "inReplyTo", "read", "bodyExcerpt", "textExcerpt", "bodyPartContentTypes", "bodyMD5Hash", "teamAccess")
