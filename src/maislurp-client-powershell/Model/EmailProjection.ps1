...
No description available.
.PARAMETER BodyPartContentTypes
No description available.
...
function ConvertFrom-JsonToEmailProjection {
    ...
    Process {
        ...
        $AllProperties = ("subject", "inboxId", "attachments", "sender", "recipients", "sizeBytes", "createdAt", "to", "cc", "bcc", "messageId", "domainId", "favourite", "plusAddress", "imapUid", "inReplyTo", "read", "bodyExcerpt", "textExcerpt", "bodyPartContentTypes", "bodyMD5Hash", "teamAccess", "id", "threadId", "from")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "plusAddress"))) { #optional property not found
            $PlusAddress = $null
        } else {
            $PlusAddress = $JsonParameters.PSobject.Properties["plusAddress"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "imapUid"))) { #optional property not found
            $ImapUid = $null
        } else {
            $ImapUid = $JsonParameters.PSobject.Properties["imapUid"].value
        }
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "bodyPartContentTypes"))) { #optional property not found
            $BodyPartContentTypes = $null
        } else {
            $BodyPartContentTypes = $JsonParameters.PSobject.Properties["bodyPartContentTypes"].value
        }
