...
function ConvertFrom-JsonToEmailProjection {
    ...
    Process {
        ...
        $AllProperties = ("sender", "recipients", "attachments", "inboxId", "createdAt", "to", "cc", "bcc", "messageId", "domainId", "favourite", "inReplyTo", "plusAddress", "sizeBytes", "read", "bodyExcerpt", "textExcerpt", "bodyPartContentTypes", "bodyMD5Hash", "teamAccess", "subject", "id", "threadId", "from")
