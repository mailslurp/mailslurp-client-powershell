...
function ConvertFrom-JsonToEmailProjection {
    ...
    Process {
        ...
        $AllProperties = ("subject", "sender", "recipients", "attachments", "inboxId", "createdAt", "to", "cc", "bcc", "messageId", "domainId", "favourite", "plusAddress", "sizeBytes", "inReplyTo", "read", "bodyExcerpt", "textExcerpt", "bodyPartContentTypes", "bodyMD5Hash", "teamAccess", "id", "threadId", "from")
