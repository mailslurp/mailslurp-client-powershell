...
function ConvertFrom-JsonToEmailProjection {
    ...
    Process {
        ...
        $AllProperties = ("subject", "sizeBytes", "messageId", "favourite", "domainId", "attachments", "inboxId", "createdAt", "to", "cc", "bcc", "sender", "recipients", "plusAddress", "imapUid", "inReplyTo", "read", "bodyExcerpt", "textExcerpt", "bodyPartContentTypes", "bodyMD5Hash", "teamAccess", "id", "threadId", "from")
