...
function ConvertFrom-JsonToEmailProjection {
    ...
    Process {
        ...
        $AllProperties = ("recipients", "sender", "attachments", "inboxId", "createdAt", "to", "cc", "bcc", "messageId", "domainId", "favourite", "plusAddress", "sizeBytes", "inReplyTo", "read", "bodyExcerpt", "textExcerpt", "bodyPartContentTypes", "bodyMD5Hash", "teamAccess", "subject", "id", "threadId", "from")
