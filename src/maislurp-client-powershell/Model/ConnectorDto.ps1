...
function ConvertFrom-JsonToConnectorDto {
    ...
    Process {
        ...
        $AllProperties = ("id", "enabled", "userId", "connectorType", "connectorAuthType", "syncEnabled", "syncScheduleType", "syncInterval", "imapHost", "imapPort", "imapUsername", "imapPassword", "imapSsl", "selectFolder", "searchTerms", "createdAt")
