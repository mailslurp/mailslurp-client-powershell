...
PageGuestPortalUsers<PSCustomObject>
#>

function Initialize-PageGuestPortalUsers {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PageGuestPortalUsers' | Write-Debug
...
Convert from JSON to PageGuestPortalUsers<PSCustomObject>
...
PageGuestPortalUsers<PSCustomObject>
#>
function ConvertFrom-JsonToPageGuestPortalUsers {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PageGuestPortalUsers' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageGuestPortalUsers
