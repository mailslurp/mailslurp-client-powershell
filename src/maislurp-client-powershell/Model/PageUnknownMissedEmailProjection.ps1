...
function Initialize-PageUnknownMissedEmailProjection {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PageUnknownMissedEmailProjection' | Write-Debug
...
Convert from JSON to PageUnknownMissedEmailProjection<PSCustomObject>
...
PageUnknownMissedEmailProjection<PSCustomObject>
#>
function ConvertFrom-JsonToPageUnknownMissedEmailProjection {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PageUnknownMissedEmailProjection' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageUnknownMissedEmailProjection
