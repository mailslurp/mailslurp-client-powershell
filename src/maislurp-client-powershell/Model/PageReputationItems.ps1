...
PageReputationItems<PSCustomObject>
#>

function Initialize-PageReputationItems {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PageReputationItems' | Write-Debug
...
Convert from JSON to PageReputationItems<PSCustomObject>
...
PageReputationItems<PSCustomObject>
#>
function ConvertFrom-JsonToPageReputationItems {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PageReputationItems' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageReputationItems
