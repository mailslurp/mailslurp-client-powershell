...
PagePhoneMessageThreadItemProjection<PSCustomObject>
#>

function Initialize-PagePhoneMessageThreadItemProjection {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PagePhoneMessageThreadItemProjection' | Write-Debug
...
Convert from JSON to PagePhoneMessageThreadItemProjection<PSCustomObject>
...
PagePhoneMessageThreadItemProjection<PSCustomObject>
#>
function ConvertFrom-JsonToPagePhoneMessageThreadItemProjection {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PagePhoneMessageThreadItemProjection' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PagePhoneMessageThreadItemProjection
        $AllProperties = ("content", "pageable", "totalPages", "totalElements", "last", "numberOfElements", "first", "size", "number", "sort", "empty")
        ...
        If ([string]::IsNullOrEmpty($Json) -or $Json -eq "{}") { # empty json
            throw "Error! Empty JSON cannot be serialized due to the required property 'totalPages' missing."
        }
