...
function ConvertFrom-JsonToThreadProjection {
    ...
    Process {
        ...
        $AllProperties = ("aliasId", "bcc", "cc", "createdAt", "id", "inboxId", "name", "subject", "to", "updatedAt", "userId")
        ...
        If ([string]::IsNullOrEmpty($Json) -or $Json -eq "{}") { # empty json
            throw "Error! Empty JSON cannot be serialized due to the required property 'aliasId' missing."
        }
