...
function Initialize-DNSLookupResults {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => DNSLookupResults' | Write-Debug
...
Convert from JSON to DNSLookupResults<PSCustomObject>
...
DNSLookupResults<PSCustomObject>
#>
function ConvertFrom-JsonToDNSLookupResults {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => DNSLookupResults' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DNSLookupResults
