...
PageSentSmsProjection<PSCustomObject>
#>

function Initialize-PageSentSmsProjection {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PageSentSmsProjection' | Write-Debug
...
Convert from JSON to PageSentSmsProjection<PSCustomObject>
...
PageSentSmsProjection<PSCustomObject>
#>
function ConvertFrom-JsonToPageSentSmsProjection {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PageSentSmsProjection' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageSentSmsProjection
