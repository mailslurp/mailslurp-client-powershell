...
RulesetDto<PSCustomObject>
#>

function Initialize-RulesetDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => RulesetDto' | Write-Debug
...
Convert from JSON to RulesetDto<PSCustomObject>
...
RulesetDto<PSCustomObject>
#>
function ConvertFrom-JsonToRulesetDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => RulesetDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RulesetDto
        $AllProperties = ("id", "inboxId", "phoneId", "scope", "action", "target", "handler", "createdAt")
