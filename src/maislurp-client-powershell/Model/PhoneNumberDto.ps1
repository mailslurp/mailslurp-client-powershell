...
function ConvertFrom-JsonToPhoneNumberDto {
    ...
    Process {
        ...
        $AllProperties = ("id", "name", "description", "userId", "complianceAddress", "emergencyAddress", "phoneNumber", "phoneCountry", "phonePlan", "createdAt", "updatedAt", "favourite", "phoneVariant")
