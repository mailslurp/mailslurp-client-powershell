...
function Initialize-DomainInformation {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => DomainInformation' | Write-Debug
...
Convert from JSON to DomainInformation<PSCustomObject>
...
DomainInformation<PSCustomObject>
#>
function ConvertFrom-JsonToDomainInformation {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => DomainInformation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DomainInformation
        $AllProperties = ("domainName", "verified", "domainType")
