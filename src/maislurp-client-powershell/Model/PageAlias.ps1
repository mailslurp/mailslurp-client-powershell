...
function Initialize-PageAlias {
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PageAlias' | Write-Debug
...
Convert from JSON to PageAlias<PSCustomObject>
...
PageAlias<PSCustomObject>
#>
function ConvertFrom-JsonToPageAlias {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PageAlias' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageAlias
