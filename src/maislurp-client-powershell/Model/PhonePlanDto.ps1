...
function Initialize-PhonePlanDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PhonePlanDto' | Write-Debug
...
Convert from JSON to PhonePlanDto<PSCustomObject>
...
PhonePlanDto<PSCustomObject>
#>
function ConvertFrom-JsonToPhonePlanDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PhonePlanDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PhonePlanDto
        $AllProperties = ("id", "userId", "phoneCountry", "createdAt")
