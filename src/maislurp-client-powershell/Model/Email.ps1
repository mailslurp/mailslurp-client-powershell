...
function ConvertFrom-JsonToEmail {
    ...
    Process {
        ...
        $AllProperties = ("analysis", "attachments", "bcc", "body", "bodyExcerpt", "bodyMD5Hash", "cc", "charset", "createdAt", "from", "headers", "id", "inboxId", "isHTML", "read", "replyTo", "subject", "teamAccess", "to", "updatedAt", "userId")
