...
function ConvertFrom-JsonToEmail {
    ...
    Process {
        ...
        $AllProperties = ("id", "userId", "inboxId", "domainId", "to", "from", "sender", "recipients", "replyTo", "cc", "bcc", "headers", "headersMap", "attachments", "subject", "body", "bodyExcerpt", "textExcerpt", "bodyMD5Hash", "isHTML", "charset", "analysis", "createdAt", "updatedAt", "read", "teamAccess", "isXAmpHtml", "bodyPartContentTypes", "html", "xampHtml")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "headersMap"))) { #optional property not found
            $HeadersMap = $null
        } else {
            $HeadersMap = $JsonParameters.PSobject.Properties["headersMap"].value
        }
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "xampHtml"))) { #optional property not found
            $XampHtml = $null
        } else {
            $XampHtml = $JsonParameters.PSobject.Properties["xampHtml"].value
        }
