...
EmailValidationRequestDto<PSCustomObject>
#>
...
function Initialize-EmailValidationRequestDto {
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => EmailValidationRequestDto' | Write-Debug
...
Convert from JSON to EmailValidationRequestDto<PSCustomObject>
...
EmailValidationRequestDto<PSCustomObject>
#>
function ConvertFrom-JsonToEmailValidationRequestDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => EmailValidationRequestDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EmailValidationRequestDto
