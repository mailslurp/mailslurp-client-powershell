...
SenderProjection<PSCustomObject>
#>

function Initialize-SenderProjection {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => SenderProjection' | Write-Debug
...
Convert from JSON to SenderProjection<PSCustomObject>
...
SenderProjection<PSCustomObject>
#>
function ConvertFrom-JsonToSenderProjection {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => SenderProjection' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SenderProjection
