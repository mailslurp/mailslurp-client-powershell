...
PagePhoneNumberReleaseProjection<PSCustomObject>
#>

function Initialize-PagePhoneNumberReleaseProjection {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PagePhoneNumberReleaseProjection' | Write-Debug
...
Convert from JSON to PagePhoneNumberReleaseProjection<PSCustomObject>
...
PagePhoneNumberReleaseProjection<PSCustomObject>
#>
function ConvertFrom-JsonToPagePhoneNumberReleaseProjection {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PagePhoneNumberReleaseProjection' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PagePhoneNumberReleaseProjection
