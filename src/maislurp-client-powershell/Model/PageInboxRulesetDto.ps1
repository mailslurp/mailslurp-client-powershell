...
function Initialize-PageInboxRulesetDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PageInboxRulesetDto' | Write-Debug
...
Convert from JSON to PageInboxRulesetDto<PSCustomObject>
...
PageInboxRulesetDto<PSCustomObject>
#>
function ConvertFrom-JsonToPageInboxRulesetDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PageInboxRulesetDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageInboxRulesetDto
