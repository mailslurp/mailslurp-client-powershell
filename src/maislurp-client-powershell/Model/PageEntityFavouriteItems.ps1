...
PageEntityFavouriteItems<PSCustomObject>
#>

function Initialize-PageEntityFavouriteItems {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PageEntityFavouriteItems' | Write-Debug
...
Convert from JSON to PageEntityFavouriteItems<PSCustomObject>
...
PageEntityFavouriteItems<PSCustomObject>
#>
function ConvertFrom-JsonToPageEntityFavouriteItems {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PageEntityFavouriteItems' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageEntityFavouriteItems
