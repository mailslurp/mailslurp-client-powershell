...
function ConvertFrom-JsonToSentEmailProjection {
    ...
    Process {
        ...
        $AllProperties = ("attachments", "bcc", "bodyMD5Hash", "cc", "createdAt", "from", "id", "inboxId", "subject", "to", "userId")
        ...
        If ([string]::IsNullOrEmpty($Json) -or $Json -eq "{}") { # empty json
            throw "Error! Empty JSON cannot be serialized due to the required property 'attachments' missing."
        }
