...
function ConvertFrom-JsonToSentEmailProjection {
    ...
    Process {
        ...
        $AllProperties = ("subject", "createdAt", "id", "from", "sender", "recipients", "userId", "attachments", "inboxId", "to", "cc", "bcc", "messageId", "inReplyTo", "bodyExcerpt", "textExcerpt", "bodyMD5Hash", "virtualSend", "threadId")
