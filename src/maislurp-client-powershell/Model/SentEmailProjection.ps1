...
function ConvertFrom-JsonToSentEmailProjection {
    ...
    Process {
        ...
        $AllProperties = ("id", "threadId", "from", "subject", "sender", "recipients", "userId", "inboxId", "attachments", "createdAt", "to", "cc", "bcc", "messageId", "inReplyTo", "virtualSend", "bodyExcerpt", "textExcerpt", "bodyMD5Hash")
