...
function ConvertFrom-JsonToSentEmailProjection {
    ...
    Process {
        ...
        $AllProperties = ("id", "recipients", "from", "sender", "subject", "attachments", "inboxId", "userId", "createdAt", "to", "cc", "bcc", "messageId", "inReplyTo", "bodyExcerpt", "textExcerpt", "bodyMD5Hash", "virtualSend", "threadId")
