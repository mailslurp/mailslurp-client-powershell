...
function ConvertFrom-JsonToSentEmailProjection {
    ...
    Process {
        ...
        $AllProperties = ("subject", "id", "userId", "inboxId", "attachments", "from", "sender", "recipients", "createdAt", "to", "cc", "bcc", "messageId", "inReplyTo", "virtualSend", "bodyExcerpt", "textExcerpt", "bodyMD5Hash", "threadId")
