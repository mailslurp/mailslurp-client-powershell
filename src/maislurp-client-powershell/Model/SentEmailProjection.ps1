...
function ConvertFrom-JsonToSentEmailProjection {
    ...
    Process {
        ...
        $AllProperties = ("id", "subject", "from", "sender", "recipients", "userId", "attachments", "inboxId", "createdAt", "to", "cc", "bcc", "messageId", "inReplyTo", "bodyExcerpt", "textExcerpt", "bodyMD5Hash", "virtualSend", "threadId")
