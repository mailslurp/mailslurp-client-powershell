...
function ConvertFrom-JsonToSentEmailProjection {
    ...
    Process {
        ...
        $AllProperties = ("subject", "id", "messageId", "userId", "attachments", "inboxId", "createdAt", "to", "cc", "bcc", "from", "sender", "recipients", "inReplyTo", "virtualSend", "bodyExcerpt", "textExcerpt", "bodyMD5Hash", "threadId")
