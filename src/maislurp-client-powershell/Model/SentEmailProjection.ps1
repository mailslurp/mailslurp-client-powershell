...
function ConvertFrom-JsonToSentEmailProjection {
    ...
    Process {
        ...
        $AllProperties = ("id", "threadId", "inReplyTo", "from", "sender", "recipients", "subject", "userId", "attachments", "inboxId", "createdAt", "to", "cc", "bcc", "messageId", "virtualSend", "bodyExcerpt", "textExcerpt", "bodyMD5Hash")
