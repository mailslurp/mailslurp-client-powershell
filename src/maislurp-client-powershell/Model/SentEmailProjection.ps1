...
function ConvertFrom-JsonToSentEmailProjection {
    ...
    Process {
        ...
        $AllProperties = ("id", "from", "sender", "recipients", "subject", "attachments", "inboxId", "userId", "createdAt", "to", "cc", "bcc", "messageId", "inReplyTo", "bodyExcerpt", "textExcerpt", "bodyMD5Hash", "virtualSend", "threadId")
