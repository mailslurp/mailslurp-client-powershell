...
FakeEmailPreview<PSCustomObject>
#>

function Initialize-FakeEmailPreview {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => FakeEmailPreview' | Write-Debug
...
Convert from JSON to FakeEmailPreview<PSCustomObject>
...
FakeEmailPreview<PSCustomObject>
#>
function ConvertFrom-JsonToFakeEmailPreview {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => FakeEmailPreview' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FakeEmailPreview
        $AllProperties = ("id", "emailAddress", "sender", "recipients", "hasAttachments", "subject", "preview", "createdAt", "seen")
