...
function Initialize-PageMissedEmailProjection {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PageMissedEmailProjection' | Write-Debug
...
Convert from JSON to PageMissedEmailProjection<PSCustomObject>
...
PageMissedEmailProjection<PSCustomObject>
#>
function ConvertFrom-JsonToPageMissedEmailProjection {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PageMissedEmailProjection' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageMissedEmailProjection
