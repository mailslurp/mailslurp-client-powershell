...
function Initialize-PageOrganizationInboxProjection {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PageOrganizationInboxProjection' | Write-Debug
...
Convert from JSON to PageOrganizationInboxProjection<PSCustomObject>
...
PageOrganizationInboxProjection<PSCustomObject>
#>
function ConvertFrom-JsonToPageOrganizationInboxProjection {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PageOrganizationInboxProjection' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageOrganizationInboxProjection
