...
MissedSmsDto<PSCustomObject>
#>

function Initialize-MissedSmsDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => MissedSmsDto' | Write-Debug
...
Convert from JSON to MissedSmsDto<PSCustomObject>
...
MissedSmsDto<PSCustomObject>
#>
function ConvertFrom-JsonToMissedSmsDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => MissedSmsDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MissedSmsDto
        $AllProperties = ("id", "userId", "phoneNumber", "fromNumber", "toNumber", "body", "sid", "createdAt", "updatedAt")
