...
function ConvertFrom-JsonToImapAccessDetails {
    ...
    Process {
        ...
        $AllProperties = ("secureImapServerHost", "secureImapServerPort", "secureImapUsername", "secureImapPassword", "imapServerHost", "imapServerPort", "imapUsername", "imapPassword", "imapMailbox")
        ...
        If ([string]::IsNullOrEmpty($Json) -or $Json -eq "{}") { # empty json
            throw "Error! Empty JSON cannot be serialized due to the required property 'secureImapServerHost' missing."
        }
