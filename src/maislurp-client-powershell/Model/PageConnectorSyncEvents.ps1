...
PageConnectorSyncEvents<PSCustomObject>
#>

function Initialize-PageConnectorSyncEvents {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PageConnectorSyncEvents' | Write-Debug
...
Convert from JSON to PageConnectorSyncEvents<PSCustomObject>
...
PageConnectorSyncEvents<PSCustomObject>
#>
function ConvertFrom-JsonToPageConnectorSyncEvents {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PageConnectorSyncEvents' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageConnectorSyncEvents
