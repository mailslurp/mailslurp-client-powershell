...
function ConvertFrom-JsonToOrganizationInboxProjection {
    ...
    Process {
        ...
        $AllProperties = ("id", "domainId", "createdAt", "name", "emailAddress", "favourite", "tags", "teamAccess", "inboxType", "readOnly", "virtualInbox", "functionsAs", "userId", "description", "expiresAt", "accountRegion")
