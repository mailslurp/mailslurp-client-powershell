...
function ConvertFrom-JsonToImapSmtpAccessDetails {
    ...
    Process {
        ...
        $AllProperties = ("secureSmtpServerHost", "secureSmtpServerPort", "secureSmtpUsername", "secureSmtpPassword", "smtpServerHost", "smtpServerPort", "smtpUsername", "smtpPassword", "imapServerHost", "imapServerPort", "imapUsername", "imapPassword")
