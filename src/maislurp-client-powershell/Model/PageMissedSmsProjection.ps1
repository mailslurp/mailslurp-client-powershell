...
PageMissedSmsProjection<PSCustomObject>
#>

function Initialize-PageMissedSmsProjection {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PageMissedSmsProjection' | Write-Debug
...
Convert from JSON to PageMissedSmsProjection<PSCustomObject>
...
PageMissedSmsProjection<PSCustomObject>
#>
function ConvertFrom-JsonToPageMissedSmsProjection {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PageMissedSmsProjection' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageMissedSmsProjection
