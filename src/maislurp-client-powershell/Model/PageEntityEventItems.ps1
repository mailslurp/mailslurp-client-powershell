...
PageEntityEventItems<PSCustomObject>
#>

function Initialize-PageEntityEventItems {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PageEntityEventItems' | Write-Debug
...
Convert from JSON to PageEntityEventItems<PSCustomObject>
...
PageEntityEventItems<PSCustomObject>
#>
function ConvertFrom-JsonToPageEntityEventItems {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PageEntityEventItems' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageEntityEventItems
