...
PagePlusAddressProjection<PSCustomObject>
#>

function Initialize-PagePlusAddressProjection {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PagePlusAddressProjection' | Write-Debug
...
Convert from JSON to PagePlusAddressProjection<PSCustomObject>
...
PagePlusAddressProjection<PSCustomObject>
#>
function ConvertFrom-JsonToPagePlusAddressProjection {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PagePlusAddressProjection' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PagePlusAddressProjection
