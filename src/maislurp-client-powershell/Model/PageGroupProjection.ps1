...
function Initialize-PageGroupProjection {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PageGroupProjection' | Write-Debug
...
Convert from JSON to PageGroupProjection<PSCustomObject>
...
PageGroupProjection<PSCustomObject>
#>
function ConvertFrom-JsonToPageGroupProjection {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PageGroupProjection' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageGroupProjection
