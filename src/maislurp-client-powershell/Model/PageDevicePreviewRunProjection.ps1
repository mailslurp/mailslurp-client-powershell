...
PageDevicePreviewRunProjection<PSCustomObject>
#>

function Initialize-PageDevicePreviewRunProjection {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PageDevicePreviewRunProjection' | Write-Debug
...
Convert from JSON to PageDevicePreviewRunProjection<PSCustomObject>
...
PageDevicePreviewRunProjection<PSCustomObject>
#>
function ConvertFrom-JsonToPageDevicePreviewRunProjection {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PageDevicePreviewRunProjection' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageDevicePreviewRunProjection
