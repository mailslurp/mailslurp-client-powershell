...
ModelSender<PSCustomObject>
#>

function Initialize-ModelSender {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => ModelSender' | Write-Debug
...
Convert from JSON to ModelSender<PSCustomObject>
...
ModelSender<PSCustomObject>
#>
function ConvertFrom-JsonToModelSender {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => ModelSender' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ModelSender
