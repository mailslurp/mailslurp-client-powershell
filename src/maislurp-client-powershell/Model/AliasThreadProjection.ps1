...
AliasThreadProjection<PSCustomObject>
#>

function Initialize-AliasThreadProjection {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => AliasThreadProjection' | Write-Debug
...
Convert from JSON to AliasThreadProjection<PSCustomObject>
...
AliasThreadProjection<PSCustomObject>
#>
function ConvertFrom-JsonToAliasThreadProjection {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => AliasThreadProjection' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AliasThreadProjection
        $AllProperties = ("subject", "createdAt", "updatedAt", "userId", "inboxId", "to", "cc", "bcc", "aliasId", "name", "id")
