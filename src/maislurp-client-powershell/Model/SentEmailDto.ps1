...
function ConvertFrom-JsonToSentEmailDto {
    ...
    Process {
        ...
        $AllProperties = ("id", "userId", "inboxId", "to", "from", "replyTo", "cc", "bcc", "attachments", "subject", "bodyMD5Hash", "body", "charset", "sentAt", "pixelIds", "html")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "sentAt"))) { #optional property not found
            $SentAt = $null
        } else {
