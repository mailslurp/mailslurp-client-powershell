...
function ConvertFrom-JsonToSentEmailDto {
    ...
    Process {
        ...
        $AllProperties = ("id", "userId", "inboxId", "domainId", "to", "from", "replyTo", "cc", "bcc", "attachments", "subject", "bodyMD5Hash", "body", "toContacts", "toGroup", "charset", "isHTML", "sentAt", "pixelIds", "messageId", "messageIds", "virtualSend", "templateId", "templateVariables", "headers", "html")
