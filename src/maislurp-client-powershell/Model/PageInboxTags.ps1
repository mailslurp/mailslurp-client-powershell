...
PageInboxTags<PSCustomObject>
#>

function Initialize-PageInboxTags {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PageInboxTags' | Write-Debug
...
Convert from JSON to PageInboxTags<PSCustomObject>
...
PageInboxTags<PSCustomObject>
#>
function ConvertFrom-JsonToPageInboxTags {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PageInboxTags' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageInboxTags
