...
function ConvertFrom-JsonToWebhookEmailReadPayload {
    ...
    Process {
        ...
        $AllProperties = ("createdAt", "emailId", "emailIsRead", "eventName", "inboxId", "messageId", "webhookId", "webhookName")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "emailIsRead"))) { #optional property not found
            $EmailIsRead = $null
        } else {
