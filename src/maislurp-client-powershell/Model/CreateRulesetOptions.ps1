...
CreateRulesetOptions<PSCustomObject>
#>

function Initialize-CreateRulesetOptions {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("RECEIVING_EMAILS", "SENDING_EMAILS", "RECEIVING_SMS", "SENDING_SMS")]
        [String]
        ${Scope},
        [Parameter(Position = 1, ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("BLOCK", "ALLOW", "FILTER_REMOVE", "BOUNCE_SOFT", "BOUNCE_HARD")]
        [String]
        ${Action},
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => CreateRulesetOptions' | Write-Debug
...
Convert from JSON to CreateRulesetOptions<PSCustomObject>
...
CreateRulesetOptions<PSCustomObject>
#>
function ConvertFrom-JsonToCreateRulesetOptions {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => CreateRulesetOptions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CreateRulesetOptions
