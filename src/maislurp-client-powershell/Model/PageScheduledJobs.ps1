...
function Initialize-PageScheduledJobs {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PageScheduledJobs' | Write-Debug
...
Convert from JSON to PageScheduledJobs<PSCustomObject>
...
PageScheduledJobs<PSCustomObject>
#>
function ConvertFrom-JsonToPageScheduledJobs {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PageScheduledJobs' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageScheduledJobs
