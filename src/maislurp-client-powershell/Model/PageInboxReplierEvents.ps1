...
PageInboxReplierEvents<PSCustomObject>
#>

function Initialize-PageInboxReplierEvents {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PageInboxReplierEvents' | Write-Debug
...
Convert from JSON to PageInboxReplierEvents<PSCustomObject>
...
PageInboxReplierEvents<PSCustomObject>
#>
function ConvertFrom-JsonToPageInboxReplierEvents {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PageInboxReplierEvents' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageInboxReplierEvents
