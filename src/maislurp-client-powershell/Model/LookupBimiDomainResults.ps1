...
LookupBimiDomainResults<PSCustomObject>
#>

function Initialize-LookupBimiDomainResults {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => LookupBimiDomainResults' | Write-Debug
...
Convert from JSON to LookupBimiDomainResults<PSCustomObject>
...
LookupBimiDomainResults<PSCustomObject>
#>
function ConvertFrom-JsonToLookupBimiDomainResults {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => LookupBimiDomainResults' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LookupBimiDomainResults
