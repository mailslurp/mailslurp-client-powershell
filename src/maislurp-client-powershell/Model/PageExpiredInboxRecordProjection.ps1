...
PageExpiredInboxRecordProjection<PSCustomObject>
#>

function Initialize-PageExpiredInboxRecordProjection {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PageExpiredInboxRecordProjection' | Write-Debug
...
Convert from JSON to PageExpiredInboxRecordProjection<PSCustomObject>
...
PageExpiredInboxRecordProjection<PSCustomObject>
#>
function ConvertFrom-JsonToPageExpiredInboxRecordProjection {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PageExpiredInboxRecordProjection' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageExpiredInboxRecordProjection
