...
PagePhoneMessageThreadProjection<PSCustomObject>
#>

function Initialize-PagePhoneMessageThreadProjection {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PagePhoneMessageThreadProjection' | Write-Debug
...
Convert from JSON to PagePhoneMessageThreadProjection<PSCustomObject>
...
PagePhoneMessageThreadProjection<PSCustomObject>
#>
function ConvertFrom-JsonToPagePhoneMessageThreadProjection {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PagePhoneMessageThreadProjection' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PagePhoneMessageThreadProjection
