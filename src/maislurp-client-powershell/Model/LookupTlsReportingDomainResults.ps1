...
LookupTlsReportingDomainResults<PSCustomObject>
#>

function Initialize-LookupTlsReportingDomainResults {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => LookupTlsReportingDomainResults' | Write-Debug
...
Convert from JSON to LookupTlsReportingDomainResults<PSCustomObject>
...
LookupTlsReportingDomainResults<PSCustomObject>
#>
function ConvertFrom-JsonToLookupTlsReportingDomainResults {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => LookupTlsReportingDomainResults' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LookupTlsReportingDomainResults
