...
PageListUnsubscribeRecipients<PSCustomObject>
#>

function Initialize-PageListUnsubscribeRecipients {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PageListUnsubscribeRecipients' | Write-Debug
...
Convert from JSON to PageListUnsubscribeRecipients<PSCustomObject>
...
PageListUnsubscribeRecipients<PSCustomObject>
#>
function ConvertFrom-JsonToPageListUnsubscribeRecipients {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PageListUnsubscribeRecipients' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageListUnsubscribeRecipients
