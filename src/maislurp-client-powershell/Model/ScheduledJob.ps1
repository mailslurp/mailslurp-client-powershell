...
ScheduledJob<PSCustomObject>
#>

function Initialize-ScheduledJob {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => ScheduledJob' | Write-Debug
...
Convert from JSON to ScheduledJob<PSCustomObject>
...
ScheduledJob<PSCustomObject>
#>
function ConvertFrom-JsonToScheduledJob {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => ScheduledJob' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ScheduledJob
