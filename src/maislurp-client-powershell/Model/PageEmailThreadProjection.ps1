...
PageEmailThreadProjection<PSCustomObject>
#>

function Initialize-PageEmailThreadProjection {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PageEmailThreadProjection' | Write-Debug
...
Convert from JSON to PageEmailThreadProjection<PSCustomObject>
...
PageEmailThreadProjection<PSCustomObject>
#>
function ConvertFrom-JsonToPageEmailThreadProjection {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PageEmailThreadProjection' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageEmailThreadProjection
