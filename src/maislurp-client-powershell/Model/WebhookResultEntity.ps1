...
function ConvertFrom-JsonToWebhookResultEntity {
    ...
    Process {
        ...
        $AllProperties = ("createdAt", "httpMethod", "id", "inboxId", "messageId", "responseBodyExtract", "responseStatus", "responseTimeMillis", "resultType", "updatedAt", "userId", "webhookEvent", "webhookId", "webhookUrl")
