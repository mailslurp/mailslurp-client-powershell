...
function Initialize-PageInboxForwarderEvents {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PageInboxForwarderEvents' | Write-Debug
...
Convert from JSON to PageInboxForwarderEvents<PSCustomObject>
...
PageInboxForwarderEvents<PSCustomObject>
#>
function ConvertFrom-JsonToPageInboxForwarderEvents {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PageInboxForwarderEvents' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageInboxForwarderEvents
