...
function Initialize-PageDeliveryStatus {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PageDeliveryStatus' | Write-Debug
...
Convert from JSON to PageDeliveryStatus<PSCustomObject>
...
PageDeliveryStatus<PSCustomObject>
#>
function ConvertFrom-JsonToPageDeliveryStatus {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PageDeliveryStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageDeliveryStatus
