...
function Initialize-PageTemplateProjection {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PageTemplateProjection' | Write-Debug
...
Convert from JSON to PageTemplateProjection<PSCustomObject>
...
PageTemplateProjection<PSCustomObject>
#>
function ConvertFrom-JsonToPageTemplateProjection {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PageTemplateProjection' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageTemplateProjection
