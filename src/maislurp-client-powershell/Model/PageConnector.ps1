...
PageConnector<PSCustomObject>
#>

function Initialize-PageConnector {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PageConnector' | Write-Debug
...
Convert from JSON to PageConnector<PSCustomObject>
...
PageConnector<PSCustomObject>
#>
function ConvertFrom-JsonToPageConnector {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PageConnector' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageConnector
