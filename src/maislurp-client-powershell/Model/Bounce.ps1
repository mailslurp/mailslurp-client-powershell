...
Bounce<PSCustomObject>
#>

function Initialize-Bounce {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => Bounce' | Write-Debug
...
Convert from JSON to Bounce<PSCustomObject>
...
Bounce<PSCustomObject>
#>
function ConvertFrom-JsonToBounce {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => Bounce' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Bounce
        $AllProperties = ("bounceMta", "bounceRecipients", "bounceSubType", "bounceType", "createdAt", "id", "notificationType", "sender", "sentToRecipients", "updatedAt", "userId")
