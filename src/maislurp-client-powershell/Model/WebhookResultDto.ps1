...
function ConvertFrom-JsonToWebhookResultDto {
    ...
    Process {
        ...
        $AllProperties = ("createdAt", "httpMethod", "id", "inboxId", "messageId", "redriveId", "responseBodyExtract", "responseStatus", "responseTimeMillis", "resultType", "seen", "updatedAt", "userId", "webhookEvent", "webhookId", "webhookUrl")
