...
function ConvertFrom-JsonToWebhookResultDto {
    ...
    Process {
        ...
        $AllProperties = ("createdAt", "httpMethod", "id", "inboxId", "messageId", "redriveId", "responseBodyExtract", "responseStatus", "responseTimeMillis", "resultType", "updatedAt", "userId", "webhookEvent", "webhookId", "webhookUrl")
