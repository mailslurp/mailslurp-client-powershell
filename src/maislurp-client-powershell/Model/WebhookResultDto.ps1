...
function ConvertFrom-JsonToWebhookResultDto {
    ...
    Process {
        ...
        $AllProperties = ("id", "userId", "webhookId", "webhookUrl", "messageId", "redriveId", "httpMethod", "webhookEvent", "responseStatus", "responseTimeMillis", "responseBodyExtract", "resultType", "createdAt", "updatedAt", "seen", "inboxId", "emailId", "attachmentId", "phoneId", "smsId", "aiTransformerId")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "aiTransformerId"))) { #optional property not found
            $AiTransformerId = $null
        } else {
            $AiTransformerId = $JsonParameters.PSobject.Properties["aiTransformerId"].value
        }
