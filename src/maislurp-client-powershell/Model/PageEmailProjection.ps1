...
function Initialize-PageEmailProjection {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PageEmailProjection' | Write-Debug
...
Convert from JSON to PageEmailProjection<PSCustomObject>
...
PageEmailProjection<PSCustomObject>
#>
function ConvertFrom-JsonToPageEmailProjection {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PageEmailProjection' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageEmailProjection
