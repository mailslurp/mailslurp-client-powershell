...
function Initialize-PageBouncedEmail {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: maislurp-client-powershell => PageBouncedEmail' | Write-Debug
...
Convert from JSON to PageBouncedEmail<PSCustomObject>
...
PageBouncedEmail<PSCustomObject>
#>
function ConvertFrom-JsonToPageBouncedEmail {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: maislurp-client-powershell => PageBouncedEmail' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBouncedEmail
